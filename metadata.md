...
type: Documentation
git-repo: https://github.com/AdobeDocs/dynamic-media-developer-resources.es-ES
index: true
...
| git-repo | Especifica la ubicación del repositorio de origen principal para uso interno |
