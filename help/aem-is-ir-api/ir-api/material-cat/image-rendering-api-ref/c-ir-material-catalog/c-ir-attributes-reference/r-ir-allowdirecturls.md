...
Establecer como `1` para permitir direcciones URL HTTP absolutas (comenzando por &quot; `http://`&quot;) en `src=` comandos. Establecer como `0` para no permitir direcciones URL absolutas.
...
Heredado de `default::AllowDirectUrls` si no está definida o si está vacío.
