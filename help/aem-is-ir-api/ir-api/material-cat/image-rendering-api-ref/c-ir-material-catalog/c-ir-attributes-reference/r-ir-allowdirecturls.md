...
Establezca en 1 para permitir direcciones URL HTTP absolutas (comenzando por &quot; `http://`&quot;) en `src=` comandos. Establezca en 0 para no permitir direcciones URL absolutas.
