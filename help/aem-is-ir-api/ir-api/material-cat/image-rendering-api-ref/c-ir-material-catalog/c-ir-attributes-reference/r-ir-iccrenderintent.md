...
Interpretación de la conversión de color. Proporciona la interpretación predeterminada para las conversiones de color cuando la interpretación no se ha especificado con `icc=`.
...
Heredado de `default::IccRenderIntent`si no está definida. Si está vacío, se aplica &quot;colorimétrico relativo&quot;.
