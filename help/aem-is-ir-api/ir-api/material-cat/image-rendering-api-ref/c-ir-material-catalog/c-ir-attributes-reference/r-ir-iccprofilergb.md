...
Cadena de texto. Si se especifica, debe ser un `icc::Name` del mapa de perfiles ICC de este catálogo de materiales o del catálogo predeterminado, o de una ruta de archivo relativa a `attribute::RootPath`. El perfil ICC al que se hace referencia debe ser un perfil de RGB.

## Predeterminado {#section-5809772f8e96438ab7626d323c66a4ba}

Heredado de `default::IccProfileRgb` si no está definida o si está vacío.
