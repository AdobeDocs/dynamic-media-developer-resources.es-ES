...
Cadena de texto. Debe estar vacío, un segmento de ruta válido relativo a la configuración del servidor de renderización de imágenes `ir.resourceRootPaths`o una ruta de archivo absoluta válida. No debe incluir delimitadores de elementos de ruta inicial y final.

## Predeterminado {#section-4a7f3ab22b0c4090b3896d29bd192b8a}

Heredado de `default::RootPath` si no está definida. Si se define pero está vacío, no contribuye a la ruta raíz del archivo de origen.
