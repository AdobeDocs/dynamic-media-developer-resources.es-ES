...
<table id="simpletable_C2D795844F624470871959842AF50BF3"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Identificador de material (clave de índice). </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Marca de tiempo de modificación de material. </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p>Caducidad de <a href="../../../../../ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-material-data-reference/r-ir-expiration-dataref.md#reference-5e93943abff54c93bf85aae3b911a3ce" type="reference" format="dita" scope="local"></a> </p></td> 
  <td class="stentry"> <p>Caducidad de la caché del cliente (intervalo de tiempo de vida). </p></td> 
 </tr> 
</table>
...
<table id="simpletable_58980295E92848B7BE471855D629F756"> 
 ...
 <tr class="strow"> 
  <td class="stentry"> <p><a href="../../../../../ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-material-data-reference/r-ir-path.md#reference-59ebb624250a4965ad1737578a2ab590" type="reference" format="dita" scope="local"> ruta de acceso </a> </p></td> 
  <td class="stentry"> <p>Ruta o URL del archivo de datos de imagen. </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p><a href="../../../../../ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-material-data-reference/r-ir-auxpath.md#reference-943ad5ee3c3b4b06bbcbb005db0dc969" type="reference" format="dita" scope="local"> rutaDeAccesoAuxiliar </a> </p></td> 
  <td class="stentry"> <p>Ruta o URL del archivo de datos secundario. </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  <td class="stentry"> <p><a href="../../../../../ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-material-data-reference/r-ir-sharp-dataref.md#reference-f79a14bd52474dfd8495115d398a30d0" type="reference" format="dita" scope="local"> agudo</a> </p></td> 
 ...
 <tr class="strow"> 
  <td class="stentry"> <p>Alineación <a href="../../../../../ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-material-data-reference/r-ir-alignment.md#reference-e52152e8dc244d0aa13b40c615d0f399" type="reference" format="dita" scope="local"></a> </p></td> 
...
<table id="simpletable_BD278D96C3324004ABBBACEDF85F8D50"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Identificador de viñeta (clave de índice). </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Marca de tiempo de modificación de viñeta. </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p>Caducidad de <a href="../../../../../ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-vignette-map-reference/r-ir-expiration-vignette.md#reference-df80829da93e4c0ab3f97a1792d9c74c" type="reference" format="dita" scope="local"></a> </p></td> 
  <td class="stentry"> <p>Caducidad de la caché del cliente (intervalo de tiempo de vida). </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p><a href="../../../../../ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-vignette-map-reference/r-ir-path-vignette.md#reference-aa1c007b63a04351b89881933deaf59c" type="reference" format="dita" scope="local"> rutaDeAcceso</a> </p></td> 
  <td class="stentry"> <p>Ruta del archivo de viñeta. </p></td> 
 </tr> 
 <tr class="strow"> 
...
<table id="simpletable_B722319F81FB4DDA9AC16B27448B8F04"> 
 <thead class="sthead"> 
  <td class="stentry"> Definiciones de macros</td> 
  <td class="stentry"> <p>Descripción </p></td> 
 </thead> 
 <tr class="strow"> 
...
<table id="simpletable_54ED156EDA394412B5C4C49AA3A32828"> 
 ...
 <tr class="strow"> 
  <td class="stentry"> <p><a href="../../../../../ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-icc-profile-map-reference/r-ir-name-icc.md#reference-7a293ede360e433782575f8f6a562ac2" type="reference" format="dita" scope="local"> Nombre</a> </p></td> 
  <td class="stentry"> <p>Nombre del perfil de color (clave de índice). </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p><a href="../../../../../ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-icc-profile-map-reference/r-ir-profilepath.md#reference-06f756dd364945ee9b50fd94db46e5be" type="reference" format="dita" scope="local"> rutaDeAccesoDePerfil</a> </p></td> 
