...
Cadena de texto. Obligatorio. Clave de índice principal para la tabla de mapa de viñetas. Cada valor `vignette::Id` debe ser único dentro de la tabla y no debe contener los caracteres &quot;,&quot;.
