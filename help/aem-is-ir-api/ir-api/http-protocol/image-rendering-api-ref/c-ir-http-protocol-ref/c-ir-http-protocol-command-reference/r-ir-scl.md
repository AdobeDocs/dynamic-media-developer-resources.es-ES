...
<table id="simpletable_EFE352FA8EF14197B6934783A2883451"> 
 <tr class="strow"> 
  <td class="stentry"> <p><span class="codeph"> <span class="varname"> factor</span> de incidencia </span> </p></td> 
  <td class="stentry"> <p>Factor de escala inversa (real, 1,0 o bueno). </p></td> 
 </tr> 
</table>

Si `scl=` se produce después `wid=` o `hei=` en la URL, cancela esos comandos y `scl=` define el tamaño de la imagen devuelta por el servidor.
...
Puede ocurrir en cualquier lugar dentro de la solicitud. Se omite si `wid=` o `hei=` se produce después `scl=` de la secuencia de comandos.

Al cambiar el tamaño de la imagen `scl=` no se cambia el valor de resolución de impresión incrustado en la imagen de respuesta.

## Predeterminado {#section-d47ab3fb5a7d486a9fc207904b3e70dd}

Si no `wid=`se especifica ni `hei=` ni `scl=` , la imagen de respuesta se ajusta al tamaño definido por `attribute::DefaultPix`. Si `attribute::DefaultPix` está vacía, la imagen de respuesta tiene el mismo tamaño que la imagen de vista de la viñeta.
