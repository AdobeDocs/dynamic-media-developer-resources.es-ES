...
`sharp=1` aplica enfoque una vez procesado el material; aplica `sharp=2` enfoque después de aplicar la escala inicial de la textura, pero antes de que se transforme en escena; `sharp=3` aplica enfoque antes y después de la transformación.
