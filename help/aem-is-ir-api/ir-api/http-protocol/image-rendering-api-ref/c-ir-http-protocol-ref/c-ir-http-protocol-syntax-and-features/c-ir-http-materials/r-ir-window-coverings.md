...
Los materiales de cobertura de ventana especifican una *ventana que abarca el archivo* de estilo (extensión [!DNL .vnw] de archivo), un archivo de datos especial similar a una viñeta, que contiene datos de máscara, iluminación, presentación y textura que definen la cubierta de la ventana.
