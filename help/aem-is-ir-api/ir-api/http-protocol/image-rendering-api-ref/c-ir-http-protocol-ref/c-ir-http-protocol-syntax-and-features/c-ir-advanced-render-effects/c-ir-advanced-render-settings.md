...
La herramienta de creación de viñetas (parte del paquete de creación de imágenes de Dynamic Media) proporciona mecanismos para controlar aspectos de bajo nivel del motor de renderización de la viñeta.
...
<table id="table_1517FC39C7344EBB9F17BE20415DB057"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Los efectos de procesamiento/sombreado alternativo anulan la configuración de la viñeta. </p> </td> 
   <td colname="col3"> <p>0 </p> </td> 
   <td colname="col4"> <p>1 </p> </td> 
   <td colname="col5"> <p>A0=Efectos de procesamiento </p> <p>A1=Ensombreado alternativo </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>U </p> </td> 
   <td colname="col2"> <p>USM (máscara de NoSharp). </p> </td> 
   <td colname="col3"> <p>0 </p> </td> 
   <td colname="col4"> <p>2 </p> </td> 
   <td colname="col5"> <p>Para usar USM, debe ser &gt; 0 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Modo de cambio de tamaño. </p> </td> 
   ...
   <td colname="col5"> <p> 
     <ul id="ul_87184BB93E7F46D59BA1AAAFA8455512"> 
      ...
      <li id="li_CAE975B91C604DA0AA493F700AEBE199">Bi-Lineal </li> 
      ...
      <li id="li_34EC85C4D15145DF80F7D3DB7B6244D3">Ventana Lanczos </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col5"> <p> 
     <ul id="ul_FD4A9D73C32F47C3BF13776BB4D2818D"> 
      ...
      <li id="li_CA93566F5D4F4D3CAA1D0816562A3851">Bi-Lineal </li> 
      <li id="li_D334ACF969E749A89A464B21C96CE8A6">Supersampling </li> 
      <li id="li_FAC72C36FF4A418F8A5B05F3B4E7C5D8">Adaptable </li> 
      <li id="li_6E9D81045A0C4804A4D35D9B239F6486">Ejemplo de Poisson </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>T </p> </td> 
   <td colname="col2"> <p>Supersampling: Aleatorio. </p> </td> 
   <td colname="col3"> <p>0 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Cambio de tamaño adaptable: Anchura. </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Poisson: Muestras/Pixel. </p> </td> 
   <td colname="col3"> <p>1 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Puntos destacados. </p> </td> 
   <td colname="col3"> <p>0 </p> </td> 
   <td colname="col4"> <p>100 </p> </td> 
   <td colname="col5"> <p> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Resalta la saturación. </p> </td> 
   <td colname="col3"> <p>0 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Sombra saturada. </p> </td> 
   <td colname="col3"> <p>0 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Intensidad de extrapolación basada en brillo. </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Resalta el ajuste. </p> </td> 
   <td colname="col3"> <p>0 </p> </td> 
   <td colname="col4"> <p>255 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Puntos destacados específicos. </p> </td> 
   <td colname="col3"> <p>0 </p> </td> 
   <td colname="col4"> <p>255 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Resalte el cambio de tono. </p> </td> 
   <td colname="col3"> <p>0 </p> </td> 
   <td colname="col4"> <p>255 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Aumento de baja saturación. </p> </td> 
   <td colname="col3"> <p> </p> </td> 
   <td colname="col4"> <p> </p> </td> 
   <td colname="col5"> <p> </p> </td> 
  </tr> 
...
<table id="table_062DCF66ACCC4A6997E3CA951C0A12B8"> 
 <thead> 
  <tr> 
   <th colname="col1" class="entry"> <p>Configuración de la composición </p> </th> 
   <th colname="col2" class="entry"> <p>Descripción </p> </th> 
  </tr>
 </thead>
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Valores predeterminados en la creación de imágenes. 
     <ul id="ul_AA7CF1A3E6984B318265BBE8FFFBB4EE">
      ...
      <li id="li_376C275FDB3548958C09BD266C77318F">J10 = Resalta la saturación (0-50). </li> 
      <li id="li_FE26429972F544869CDFE2DD61F39CC5">K200 = saturación de la sombra (0-400). </li> 
      ...
      <li id="li_949B6DB4959B46A892787CD5B3AD7485">W100 = cantidad USM (1%-500%). </li> 
      <li id="li_F39D3834D4A2478D993E5E9C9B434CFE">X0 = Umbral USM (niveles 0-255). </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_AAEC098CED1C436E933B1C1B88DFB659"> 
      ...
      <li id="li_E36886FB1D00444CBA19D7245E89B292">Toda la compensación máxima y de brillo está desactivada. </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_6BB668C6C055493DAAA38F4D3B9C20A7"> 
      ...
      <li id="li_DA685F4DE4BA427BA7BE241A75C96152">Toda la compensación máxima y de brillo está desactivada. </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7C374842312E4AD0B62692BBCE6743A8"> 
      <li id="li_CC730580B54741FBBBFF507DE0FE1F15">H80 = cantidad USM </li> 
      <li id="li_C2801B2C093444AC9401793BC571EC27">I70 = Puntos destacados </li> 
      <li id="li_518C6A690EC34614B0806A0C6BC535FF">J40 = Resalta la saturación </li> 
      <li id="li_F280CF29D1E341D9AC9C0C16C2DEA1E6">L300 = Intensidad de extrapolación basada en pérdidas </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Sombreado alternativo con enfoque: </p> <p> 
     <ul id="ul_93AD53BB37EA47F6A3CEE424D3AAE18C"> 
      ...
      <li id="li_7B5D8B7BB5544E7FA4AD702EE281086B">Monto USM (120) </li> 
      <li id="li_B3BE096BB0654A2DBADDD6832E499F2A">Radio USM (0.6) </li> 
      <li id="li_793DAB145CE7469ABC1182BCBD324657">Umbral USM (5) </li> 
      <li id="li_B1954FEBE2084726828D64E8165DA4DA">Cambio de tamaño (Lanczos) </li> 
      <li id="li_E5ED76998C0543D8A3F9AD178CFD3C2C">Ejemplo (Supersampling, random=mid, rate=Half) </li> 
      <li id="li_CCEE53544E7D48858398BF3168F1E87D">Contraste (más fuerte) </li> 
      <li id="li_EB0D25C095FB4D5798AC031AB759849B">Ajuste de la saturación (primer vértice en el centro, segundo vértice a lo largo del borde, tercer vértice punto medio bajo) </li> 
      <li id="li_5C2304DA4A4D4799AE5DCCCB1E2ECBB3">Enfoque (3/4 camino a la derecha) </li> 
     </ul> </p> </td> 
  </tr> 
 </tbody> 
</table>
