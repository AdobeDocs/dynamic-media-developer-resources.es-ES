...
<table id="table_1517FC39C7344EBB9F17BE20415DB057"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col5"> <p> 
     <ul id="ul_87184BB93E7F46D59BA1AAAFA8455512"> 
      ...
      <li id="li_CAE975B91C604DA0AA493F700AEBE199">Bilineal </li> 
  ...
  <tr> 
   ...
   <td colname="col5"> <p> 
     <ul id="ul_FD4A9D73C32F47C3BF13776BB4D2818D"> 
      ...
      <li id="li_CA93566F5D4F4D3CAA1D0816562A3851">Bilineal </li> 
      <li id="li_D334ACF969E749A89A464B21C96CE8A6">Supersampling </li> 
      <li id="li_FAC72C36FF4A418F8A5B05F3B4E7C5D8">Adaptable </li> 
      <li id="li_6E9D81045A0C4804A4D35D9B239F6486">Muestra de Poisson </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Poisson: Muestras/Píxeles. </p> </td> 
   <td colname="col3"> <p>1 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Poisson: Utilice la opción de alternar. </p> </td> 
   <td colname="col3"> <p>0 </p> </td> 
   <td colname="col4"> <p>1 </p> </td> 
   <td colname="col5"> <p>El valor predeterminado es 1. </p> </td> 
  </tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Saturación de la sombra. </p> </td> 
   <td colname="col3"> <p>0 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col5"> <p>El valor predeterminado está activado (en blanco) y no seleccionado = F100G0. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Ajustes destacados. </p> </td> 
   <td colname="col3"> <p>0 </p> </td> 
   <td colname="col4"> <p>255 </p> </td> 
...
<table id="table_062DCF66ACCC4A6997E3CA951C0A12B8"> 
 <thead> 
  <tr> 
   <th colname="col1" class="entry"> <p>Definición de la composición </p> </th> 
   <th colname="col2" class="entry"> <p>Descripción </p> </th> 
  </tr>
 </thead>
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Valores predeterminados en Image Authoring. 
     <ul id="ul_AA7CF1A3E6984B318265BBE8FFFBB4EE">
      ...
      <li id="li_FB6BAA708427428AA4A3AC2E5D3B9932">L400 = Concentración de extrapolación basada en la pérdida de brillo (100-600). </li> 
      ...
      <li id="li_F39D3834D4A2478D993E5E9C9B434CFE">X0 = umbral USM (niveles de 0 a 255). </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7C374842312E4AD0B62692BBCE6743A8"> 
      ...
      <li id="li_F280CF29D1E341D9AC9C0C16C2DEA1E6">L300 = Concentración de extrapolación basada en la pérdida de brillo </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Sombreado alternativo con enfoque: </p> <p> 
     <ul id="ul_93AD53BB37EA47F6A3CEE424D3AAE18C"> 
      ...
      <li id="li_EB0D25C095FB4D5798AC031AB759849B">Ajuste de saturación (primer vértice en el medio, segundo vértice a lo largo del borde, tercer vértice en el punto medio) </li> 
      <li id="li_5C2304DA4A4D4799AE5DCCCB1E2ECBB3">Enfocar (paso 3/4 a la derecha) </li> 
     </ul> </p> </td> 
  </tr> 
 </tbody> 
</table>
