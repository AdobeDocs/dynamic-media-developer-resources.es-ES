...
# API de renderización de imágenes{#image-rendering-api}

La referencia de la API de renderización de imágenes contiene información sobre la configuración y el uso de la API de renderización de imágenes de Dynamic Media.
