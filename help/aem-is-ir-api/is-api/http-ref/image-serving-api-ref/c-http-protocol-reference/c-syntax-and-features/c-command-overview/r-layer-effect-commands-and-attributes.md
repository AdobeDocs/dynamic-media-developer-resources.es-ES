---
description: Estos comandos se pueden utilizar para definir efectos de capa, como efectos de sombra paralela o resplandor. Las capas de efectos omiten todos los demás comandos.
seo-description: Estos comandos se pueden utilizar para definir efectos de capa, como efectos de sombra paralela o resplandor. Las capas de efectos omiten todos los demás comandos.
seo-title: Comandos del efecto Capa
solution: Experience Manager
title: Comandos del efecto Capa
...
<table id="simpletable_3094B9783772437FAACF9B382F7A32EE"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Inicio el segmento de capa del efecto y especifica el orden z. </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Añade el ruido al efecto. </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Coloca la capa del efecto en relación con su capa principal. </p></td> 
 </tr> 
</table>
