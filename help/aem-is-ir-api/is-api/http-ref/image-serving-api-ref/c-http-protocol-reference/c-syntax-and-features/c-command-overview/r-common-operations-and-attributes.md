---
description: Estos comandos se aplican a las capas de imagen, texto y color sólido. También suelen ser útiles en el caso de imágenes compuestas y solicitudes de imagen simples y sin capas.
...
Estos comandos se aplican a las capas de imagen, texto y color sólido. También suelen ser útiles en el caso de imágenes compuestas y solicitudes de imagen simples y sin capas.
...
<table id="simpletable_996969D618C94BE8B81FAED512B5B7BA"> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Desenfoca la capa. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Ajusta el brillo de la capa. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Ajusta el rojo, el verde y el azul de forma independiente. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Colorea los datos de la capa. </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Cambia el tono de todos los colores. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Invertir colores. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Añade ruido a la capa. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Ajusta la saturación de color. </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Aplica máscara de enfoque. </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  <td class="stentry"> <p> <a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-rotate.md#reference-12abb086635546ec9ec2e1a793dc1096" type="reference" format="dita" scope="local"> rotar</a> </p></td> 
  <td class="stentry"> <p>Gira la capa. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Transforme la capa en perspectiva. </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p> <a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-clippath.md#reference-8139b1b52dc54749b51b109521ddf83d" type="reference" format="dita" scope="local"> rutaDeAccesoDeClip</a> </p></td> 
  <td class="stentry"> <p>Especifica las formas de clip para la capa. </p></td> 
 </tr> 
 <tr class="strow"> 
