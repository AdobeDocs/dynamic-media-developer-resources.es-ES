...
<table id="simpletable_8C9DB0DA5F2B4C068794415602B768CB"> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>En las secciones de sintaxis, el texto que no está en cursiva es literal. Esta regla no se aplica al espacio en blanco ni a los símbolos [ ] { } | *. </p> </td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p>'literal' </p> </td> 
