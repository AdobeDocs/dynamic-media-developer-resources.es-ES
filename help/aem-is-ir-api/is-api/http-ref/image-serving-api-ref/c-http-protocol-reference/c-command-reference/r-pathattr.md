...
Atributo de capa. Se omite si la capa no incluye `textPs=` ni comandos `textPath=` .

*`startPos`* debe ser bueno o igual a 0 y menor que 1.0. *`endPos`* debe ser bueno *`startPos`* y menor que o igual a 1,0 cuando se aplique a una ruta abierta, o menor o igual que ( *`startPos`* + 1,0) cuando se aplique a una ruta cerrada.
