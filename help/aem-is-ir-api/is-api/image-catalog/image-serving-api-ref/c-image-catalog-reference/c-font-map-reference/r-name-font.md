...
Cadena de texto. Obligatorio. Clave de índice principal para el mapa de fuentes. El mismo valor font::Name puede aparecer hasta cuatro veces en el mismo archivo de asignación de fuentes, pero cada registro debe tener una combinación diferente de valores `font::Bold` y `font::Italic`.
