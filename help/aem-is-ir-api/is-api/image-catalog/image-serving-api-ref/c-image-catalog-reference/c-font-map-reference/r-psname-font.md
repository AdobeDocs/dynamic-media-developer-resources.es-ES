...
Cadena de texto. Opcional. Clave de índice secundaria para el mapa de fuente. El mismo `font::PsName` valor puede ocurrir sólo una vez en el mismo archivo de asignación de fuentes.
