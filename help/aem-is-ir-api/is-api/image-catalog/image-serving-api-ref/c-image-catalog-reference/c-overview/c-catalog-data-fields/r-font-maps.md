---
description: Los siguientes campos se reconocen en los archivos de mapa de fuentes.
...
Los siguientes campos se reconocen en los archivos de mapa de fuentes.
...
<table id="simpletable_D04FFCE02C7140E38D58FB2C916EABF3"> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Indicador de cara en negrita (clave de índice secundaria). </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Indicador de cursiva (clave de índice terciaria). </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Nombre de la fuente Postscript (para procesamiento FXG). </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p><span class="codeph"> <a href="/help/aem-is-ir-api/is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-font-map-reference/r-fontpath-font.md" type="reference" format="dita" scope="local"> rutaDeAccesoDeFuente</a></span> </p></td> 
