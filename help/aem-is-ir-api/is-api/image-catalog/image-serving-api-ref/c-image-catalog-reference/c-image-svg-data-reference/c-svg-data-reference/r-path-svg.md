...
El servidor utiliza las reglas de resolución de rutas descritas en [Administración de datos](../../../../../../is-api/image-serving-api-ref/c-configuration-and-administration/c-configuration-and-administration.md#concept-1ec4d9f0e58a430cae045761f1ff9173) de origen para encontrar el archivo de datos.
...
Las aplicaciones que requieren datos de imagen en varias resoluciones diferentes tendrán un mejor rendimiento al utilizar el formato de varias resoluciones TIFF (PTIFF) piramidal de Scene7. La utilidad IC se utiliza para crear imágenes PTIFF a partir de cualquier formato de imagen admitido.
