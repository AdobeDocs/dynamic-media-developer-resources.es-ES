...
Se hereda de `default::ErrorImage` si no se define. Si se define pero está vacío, el comportamiento de la imagen de error se desactiva, incluso si `default::ErrorImage` se define, y se devuelve un estado de error HTTP y un mensaje de texto.
