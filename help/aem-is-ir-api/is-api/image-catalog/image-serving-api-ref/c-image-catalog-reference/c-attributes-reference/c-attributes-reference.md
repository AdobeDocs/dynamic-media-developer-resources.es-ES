---
description: Todos los atributos de catálogo son opcionales, excepto el RootId del catálogo.
...
Todos los atributos de catálogo son opcionales, excepto catalog::RootId.

Todos los atributos son necesarios en el archivo de atributos de catálogo predeterminado ( [!DNL default.ini]).

* [AllowDirectAccess](r-allowdirectaccess.md)
* [AllowDirectUrls](r-allowdirecturls.md)
* [ApplyEffectMask](r-applyeffectmask.md)
* [VelocidadBitsAudio](r-audiobitrate.md)
* [Bfc](r-bfc.md)
...
* [ArchivoMapaDeFuente](r-fontmapfile.md)
...
* [ArchivoMapaPerfilIcc](r-iccprofilemapfile.md)
