...
Solo se usa para solicitudes de miniaturas ( `req=tmb`) y cuándo `catalog::ThumbType` se establece en 2 o 3.
...
Heredado de `default::ThumbBkgColor` si no se define o si está vacío.
