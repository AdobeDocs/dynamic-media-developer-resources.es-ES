...
El servidor limita el tamaño de las imágenes de respuesta a esta altura y anchura máximas, a condición de que se produzca una solicitud de miniatura ( `req=tmb`) no especifica el tamaño explícitamente ni especifica el tamaño de vista explícitamente usando `wid=`, `hei=`, o `scl=`.
...
Heredado de `default::DefaultThumbPix` si no se define o si está vacío.
