...
Activa o desactiva la compatibilidad con URL absolutas incrustadas en `src=` y `mask=` comandos. Cuando está desactivado, solo las direcciones URL relativas a `attribute::RootUrl` están permitidos.
