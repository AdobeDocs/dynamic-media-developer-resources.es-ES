...
<table id="table_534AF33FE5C4453EACAE0DF35E8E3B63"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>aplicación J2EE. Gestiona el [!DNL Platform Server]Los cachés de datos de . Acceso HTTP en /is/cache. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Una o más instancias del servicio de renderización de texto pueden estar activas cuando <span class="codeph"> textPs=</span> se ejecutan. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Componente de procesamiento del SVG </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Requiere una licencia independiente para activarla. Acceso HTTP en <span class="filepath"> /ir/render</span>. Toda la funcionalidad de renderización de imágenes está integrada en la variable [!DNL Platform Server] y Image Server, sin componentes ejecutables independientes. </p> </td> 
  </tr> 
 </tbody> 
</table>
