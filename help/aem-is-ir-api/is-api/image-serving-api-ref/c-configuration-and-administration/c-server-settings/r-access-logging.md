...
## TC::maxDays - Número de días para guardar los archivos de registro {#section-45cbecffc5694c87b7d5c176a44a4885}
...
<table id="table_7A07AFF34B5040A5B30F5735CFE9428F"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>La dirección IP del servidor del mismo nivel en el clúster de caché que proporcionó la entrada de caché o '-' si <span class="codeph"> CacheUse </span> no es ni <span class="codeph"> REMOTE_CREATED </span> ni <span class="codeph"> REMOTE_UPDATED </span>. </p> </td> 
  </tr> 
  <tr> 
