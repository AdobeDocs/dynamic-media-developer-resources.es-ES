...
<table id="table_71A565DF5EC94913AD35CB13B0C7A27D"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>El TTL para este elemento de contenido; <span class="codeph"> atributo::Caducidad </span> se utiliza si no se especifica o si está vacío. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> catálogo::TimeStamp </span> </p> </td> 
   <td colname="col2"> <p>Marca de tiempo de modificación del archivo; requerido cuando la validación basada en catálogo está habilitada con <span class="codeph"> atributo::CacheValidationPolicy </span>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Tipo de datos opcional; se puede usar para filtrar solicitudes de contenido estático con la variable <span class="codeph"> type= comando </span>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
Este mecanismo puede ayudar a garantizar que los clientes reciban únicamente los contenidos adecuados para sus necesidades. Suponiendo que el contenido estático esté etiquetado con las etiquetas adecuadas `catalog::UserType` , el cliente puede agregar la variable `type=` a la solicitud. El servicio de imágenes compara el valor proporcionado con la variable `type=` al valor de `catalog::UserType` y, si no coincide, devuelve un error en lugar de contenido potencialmente inapropiado.
