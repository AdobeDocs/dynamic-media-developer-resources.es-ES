...
Establezca los atributos en el elemento raíz de FXG.

` setAttr.rootElement={ *[!DNL attributeName]*= *[!DNL attributeValue]*%26 *[!DNL attributeName]*= *[!DNL attributeValue]*}`

Este comando puede manipular los atributos del elemento raíz.
...
El elemento raíz ahora cambia a lo siguiente:
