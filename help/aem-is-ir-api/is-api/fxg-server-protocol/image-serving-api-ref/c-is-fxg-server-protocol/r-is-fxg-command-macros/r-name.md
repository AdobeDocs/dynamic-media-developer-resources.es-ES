...
El comando *`name`* no distingue entre mayúsculas y minúsculas y puede consistir en cualquier combinación de letras, números, `-` (guion), `_` (guion bajo) y `.` (punto) caracteres.
