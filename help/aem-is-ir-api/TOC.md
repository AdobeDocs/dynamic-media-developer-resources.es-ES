...
+ API de servicio de imágenes {#image-serving-api}
   ...
   + Referencia de protocolo HTTP {#http-protocol-reference}
      ...
      + Sintaxis y características {#syntax-and-features}
         ...
         + [asistencia al SVG](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/r-svg-support.md)
         ...
         + [Marcas de agua](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/r-watermarks.md)
      ...
      + Referencia de comandos {#command-reference}
         ...
         + [recortar](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-crop.md)
   ...
   + Referencia del protocolo del servidor FXG {#fxg-server-protocol-ref}
      ...
      + Protocolo del servidor FXG {#fxg-server-protocol}
         ...
         + Operaciones de manipulación DOM de FXG {#fxg-dom-ops}
   ...
   + Atributos {#attributes}
      ...
      + [Marca de agua](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-attributes-reference/r-watermark.md)
   + Referencia de datos de imagen/SVG {#image-svg-ref}
      ...
      + Datos de contenido estático {#static-content-data}
         ...
         + [Vencimiento](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-image-svg-data-reference/c-static-content-data-reference/r-expiration-static.md)
...
+ API de renderización de imágenes {#image-rendering-api}
   ...
   + Referencia de protocolo HTTP {#http-protocol-reference}
      ...
      + Sintaxis y características del protocolo HTTP {#http-protocol-syntax}
         ...
         + Materiales {#materials}
            ...
            + [Contenedores](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-http-materials/r-ir-cabinets.md)
   ...
   + Catálogo de materiales {#material-catalog}
      ...
      + Referencia de datos materiales {#material-data-reference}
         ...
         + [Vencimiento](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-material-data-reference/r-ir-expiration-dataref.md)
      ...
      + Referencia de mapa de viñetas {#vignette-map-reference}
         ...
         + [Vencimiento](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-vignette-map-reference/r-ir-expiration-vignette.md)
