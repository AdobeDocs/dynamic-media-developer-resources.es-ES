...
product: adobe
archtype: end-user
user-guide-title: API de servicio y renderización de imágenes de Dynamic Media
breadcrumb-title: API de servicio y renderización de imágenes de Dynamic Media
...
# API de servicio y renderización de imágenes de Dynamic Media {#image-serving-api}
...
+ [Convenciones de los documentos](r-document-conventions.md)
+ Instalación {#install}
   ...
   + [Carpeta Instalar](c-installation/c-install-folder.md)
   + Instalar en Windows {#windows-install}
      + [Instalar en Windows](c-installation/t-installing-on-windows/t-installing-on-windows.md)
      + [Instalación por primera vez](c-installation/t-installing-on-windows/t-first-time-installation-win.md)
      + [Instalación en una cuenta de usuario diferente a un administrador](c-installation/t-installing-on-windows/t-diff-account-win.md)
      + [Actualización de IS 4.7.4 o posterior](c-installation/t-installing-on-windows/t-update-win.md)
   ...
   + Instalación en Linux {#linux-install}
      ...
      + [Actualización de IS 4.7.4 o posterior](c-installation/c-installing-linux/t-update-lin.md)
...
+ API de servicio de imágenes {#image-serving-api}
   ...
   + Configuración y administración {#config-admin}
      ...
      + Cachés de datos {#data-caches}
         + [Resumen de las cachés de datos](is-api/image-serving-api-ref/c-configuration-and-administration/c-data-caches/c-data-caches.md)
         ...
         + [Clustering de caché](is-api/image-serving-api-ref/c-configuration-and-administration/c-data-caches/c-cache-clustering.md)
      + Configuración del servidor {#server-settings}
         ...
         + [Clustering de caché](is-api/image-serving-api-ref/c-configuration-and-administration/c-server-settings/r-cache-clustering.md)
         + [Monitorización y sistema de alertas](is-api/image-serving-api-ref/c-configuration-and-administration/c-server-settings/r-monitoring-and-alerting-system.md)
         ...
         + [Respuestas de conjuntos de medios](is-api/image-serving-api-ref/c-configuration-and-administration/c-server-settings/r-media-set-responses.md)
      + [Redirigir en caso de error](is-api/image-serving-api-ref/c-configuration-and-administration/c-redirect-on-error.md)
      ...
      + Monitorización del servidor {#server-monitoring}
         + [Supervisión del servidor](is-api/image-serving-api-ref/c-configuration-and-administration/c-server-monitoring/c-server-monitoring.md)
         ...
         + [Alerta de prioridad del espacio de montículos](is-api/image-serving-api-ref/c-configuration-and-administration/c-server-monitoring/c-heap-space-priority-alert.md)
   ...
   + [Servicio de contenido estático (no de imagen)](is-api/image-serving-api-ref/c-serving-static-nonimage-contents.md)
   ...
   + Referencia de protocolo HTTP {#http-protocol-reference}
      + [Resumen de referencia del protocolo HTTP](is-api/image-serving-api-ref/c-http-protocol-reference/c-http-protocol-reference.md)
      + Introducción al protocolo HTTP {#http-protocol-introduction}
         ...
         + [Convenciones de los documentos](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-introduction/r-document-conventions.md)
      + Sintaxis y características {#syntax-and-features}
         ...
         + Comando de protocolo HTTP de servicio de imágenes {#image-serving-http}
            ...
            + [Solicitud, comandos](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/c-command-overview/r-request-commands-and-attributes.md)
         ...
         + Capas {#layering}
            + [Información general sobre capas](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/c-layering-overview/c-layering-overview.md)
            ...
            + [Orden de las capas](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/c-layering-overview/c-layer-order.md)
         ...
         + [Mapas de imágenes](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/r-image-maps.md)
         ...
         + [Servicio de contenido estático (no de imagen)](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/r-serving-static-non-image-content.md)
      ...
      + Formato de texto {#text-formatting}
         + [Información general sobre el formato de texto](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-text-formatting/c-text-formatting.md)
         ...
         + [Colocación de texto](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-text-formatting/r-text-positioning.md)
         ...
         + Soporte de RTF {#rtf-support}
            + [Comandos y palabras clave RTF admitidos](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-text-formatting/c-supported-rtf-commands-and-keywords/c-supported-rtf-commands-and-keywords.md)
         ...
         + [Ejemplos de codificación de RTF](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-text-formatting/r-rtf-encoding-examples.md)
      ...
      + Referencia de comandos {#command-reference}
         ...
         + [ampliar](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-extend.md)
         ...
         + req {#req}
            + [información general de req](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-req/r-req.md)
      ...
      + Comportamiento del servidor {#server-behavior}
         ...
         + [Escalado de miniatura](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-notes-on-server-behavior/r-thumbnail-scaling.md)
      ...
      + Plantillas {#templates}
         + [Ejemplos de plantilla](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-templates/c-templates.md)
   ...
   + Referencia del protocolo del servidor FXG {#fxg-server-protocol-ref}
      ...
      + Protocolo de servidor FXG {#fxg-server-protocol}
         + [Protocolo del servidor FXG](is-api/fxg-server-protocol/image-serving-api-ref/c-is-fxg-server-protocol/c-fxg-server-protocol.md)
         + Referencia del protocolo del servidor FXG {#protocol-ref}
            + [Información general sobre la referencia del protocolo del servidor FXG](is-api/fxg-server-protocol/image-serving-api-ref/c-is-fxg-server-protocol/c-fxg-server-protocol-reference/c-fxg-server-protocol-reference.md)
            ...
            + [printMark](is-api/fxg-server-protocol/image-serving-api-ref/c-is-fxg-server-protocol/c-fxg-server-protocol-reference/r-printermark.md)
         ...
         + Operaciones de manipulación de FXG DOM {#fxg-dom-ops}
            + [Operaciones de manipulación DOM de FXG](is-api/fxg-server-protocol/image-serving-api-ref/c-is-fxg-server-protocol/c-dom-manipulation-operations/c-dom-manipulation-operations.md)
         ...
         + Comandos de procesamiento por lotes {#batch-process-commands}
            ...
            + [batchjobdetail estado](is-api/fxg-server-protocol/image-serving-api-ref/c-is-fxg-server-protocol/c-batch-processing-commands/r-batchjobdetailedstatus.md)
   ...
   + Referencia del catálogo de imágenes {#image-catalog-reference}
      ...
      + Campos de datos del catálogo {#catalog-data-fields}
         ...
         + [Mapas de perfiles ICC](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-overview/c-catalog-data-fields/r-icc-profile-maps.md)
   ...
   + Atributos {#attributes}
      ...
      + [ArchivoCatálogo](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-attributes-reference/r-catalogfile.md)
      ...
      + [Mapa de configuración regional](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-attributes-reference/r-localemap.md)
      ...
      + [ArchivoMacro](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-attributes-reference/r-macrofile.md)
      ...
      + [Resolución de impresión](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-attributes-reference/r-printresolution.md)
      ...
      + [ArchivoCatálogoSvg](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-attributes-reference/r-svgcatalogfile.md)
   ...
   + Referencia de datos de imagen/SVG {#image-svg-ref}
      ...
      + Referencia de datos de imagen {#image-data-reference}
         ...
         + [Resolución de impresión](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-image-svg-data-reference/c-image-data-reference/r-printresolution-cat.md)
      ...
      + Referencia de datos SVG {#svg-data-reference}
         + [Referencia de datos de SVG](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-image-svg-data-reference/c-svg-data-reference/c-svg-data-reference.md)
   ...
   + Biblioteca de imágenes estáticas interactiva {#responsive-static-image-library}
...
+ API de procesamiento de imágenes {#image-rendering-api}
   + [API de renderización de imágenes](ir-api/image-rendering-api-ref/c-ir-home.md)
   + Configuración {#configuration}
      ...
      + [Configuración y configuración del módulo de compatibilidad de IR 3.x](ir-api/image-rendering-api-ref/c-ir-installation/t-ir-setup-compatibility-module.md)
      + [Configuración y configuración de la representación de imágenes](ir-api/image-rendering-api-ref/c-ir-installation/c-ir-setup-ir.md)
   ...
   + Administración del servidor {#server-administration}
      ...
      + Referencia de configuración {#configuration-settings-reference}
         + [Información general de referencia de ajustes de configuración](ir-api/server-admin/image-rendering-api-ref/c-ir-server-administration/c-ir-configuration-settings-reference/c-ir-configuration-settings-reference.md)
   ...
   + Referencia de protocolo HTTP {#http-protocol-reference}
      ...
      + Sintaxis del protocolo HTTP y características {#http-protocol-syntax}
         ...
         + [Sintaxis básica del protocolo HTTP de renderización de imágenes](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/r-ir-basic-syntax.md)
         + Descripción general del comando del protocolo HTTP de renderización de imágenes {#image-rendering-http-protocol-command-overview}
            + [Descripción general del comando del protocolo HTTP de renderización de imágenes](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-command-overview/c-ir-command-overview.md)
         ...
         + Viñetas {#vignettes}
            ...
            + [Resolución del material](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-vignettes/c-ir-material-resolution.md)
         + Materiales {#materials}
            ...
            + [Bordes de muro](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-http-materials/r-ir-wall-borders.md)
            ...
            + [Cubiertas de ventana](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-http-materials/r-ir-window-coverings.md)
         + Efectos de procesamiento avanzados {#advanced-render-effects}
            + [Efectos de procesamiento avanzados](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-advanced-render-effects/c-ir-advanced-render-effects.md)
            ...
            + [Colorización de materiales](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-advanced-render-effects/c-ir-colorizing-materials.md)
         ...
         + Anidado e incrustación de solicitudes {#request-nesting-and-embedding}
            + [Anidado e incrustación de solicitudes *](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-request-nesting-and-embedding/c-ir-request-nesting-and-embedding.md)
            ...
            + [Solicitudes de renderización de imágenes anidadas](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-request-nesting-and-embedding/c-ir-nested-image-rendering-requests.md)
         ...
         + Variables personalizadas {#custom-variables}
            + [Información general sobre variables personalizadas](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-custom-variables/c-ir-custom-variables.md)
         ...
         + [Gestión de color de renderización de imágenes *](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-color-management.md)
         ...
         + [Codificación HTTP de renderización de imágenes](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-http-encoding.md)
      + Referencia de comando de protocolo HTTP {#http-protocol-command-reference}
         ...
         + [calco](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-decal.md)
         ...
         + [pérdida de brillo](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-http-gloss.md)
         ...
         + [grut](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-grout.md)
         ...
         + [round](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-rough.md)
         ...
         + [enfocar](ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-http-sharpen.md)
   ...
   + Catálogo de materiales {#material-catalog}
      ...
      + Referencia de atributos {#attributes-reference}
         ...
         + [ArchivoCatálogo](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-attributes-reference/r-ir-catalogfile.md)
         ...
         + [ArchivoMacro](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-attributes-reference/r-ir-macrofile.md)
         ...
         + [MostrarObjetosSuperpuestos](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-attributes-reference/r-ir-showoverlapobjs.md)
         ...
         + [Dominios de confianza *](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-attributes-reference/r-ir-trusteddomains.md)
         ...
         + [Archivo de mapa de viñetas](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-attributes-reference/r-ir-vignettemapfile.md)
      + Referencia de datos materiales {#material-data-reference}
         + [Referencia de datos materiales](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-material-data-reference/c-ir-material-data-reference.md)
         ...
         + [Color base](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-material-data-reference/r-ir-basecolor.md)
      ...
      + Referencia del conjunto de reglas {#rule-set-reference}
         + [Referencia del conjunto de reglas](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-rule-set-reference/c-ir-rule-set-reference.md)
...
+ Utilidades {#utilites}
   + [Información general sobre utilidades](utilities/utilities.md)
   ...
   + Conversor de viñetas (vntc){#vignette-converter-vntc}
      ...
      + [Conversor de viñetas](ir-api/vntc/utilities/c-ir-vignette-converter-vntc/c-ir-vignette-converter.md)
      + [Escalado de viñeta](ir-api/vntc/utilities/c-ir-vignette-converter-vntc/c-ir-vignette-scaling.md)
      ...
      + [Opciones para archivos de estilo de archivador](ir-api/vntc/utilities/c-ir-vignette-converter-vntc/r-ir-options-for-cabinet-style-files.md)
