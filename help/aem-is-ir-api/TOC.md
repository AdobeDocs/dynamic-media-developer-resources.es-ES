...
+ [Inicio de la API de servicio y procesamiento de imágenes de Dynamic Media](homeisir.md)
...
+ Instalación {#install}
   ...
   + Inicio y detención del servicio de imágenes {#start-stop-image-servicing}
...
+ API de servicio de imágenes {#image-serving-api}
   ...
   + Referencia del protocolo HTTP {#http-protocol-reference}
      ...
      + Sintaxis y características {#syntax-and-features}
         ...
         + Comando del protocolo HTTP del servicio de imágenes {#image-serving-http}
   ...
   + Referencia de protocolo del servidor FXG {#fxg-server-protocol-ref}
      ...
      + Protocolo de servidor FXG {#fxg-server-protocol}
         ...
         + Referencia de protocolo del servidor FXG {#protocol-ref}
   ...
   + Referencia de datos de Image/SVG {#image-svg-ref}
      + [Referencia de datos de Image/SVG](is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-image-svg-data-reference/c-image-svg-data-reference.md)
...
+ API de procesamiento de imágenes {#image-rendering-api}
   ...
   + Catálogo de materiales {#material-catalog}
      ...
      + Referencia de atributos {#attributes-reference}
         ...
         + [ArchivoMapaPerfilIcc](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-attributes-reference/r-ir-iccprofilemapfile.md)
         ...
         + [RutaRaíz *](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-attributes-reference/r-ir-rootpath.md)
         ...
         + [ArchivoMapaViñeta](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-attributes-reference/r-ir-vignettemapfile.md)
      + Referencia de datos de material {#material-data-reference}
         + [Referencia de datos de material](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-material-data-reference/c-ir-material-data-reference.md)
         ...
         + [ColorBase](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-material-data-reference/r-ir-basecolor.md)
      ...
      + Referencia de mapa de perfiles ICC {#icc-profile-map-reference}
         + [Referencia de mapa de perfiles ICC](ir-api/material-cat/image-rendering-api-ref/c-ir-material-catalog/c-ir-icc-profile-map-reference/c-ir-icc-profile-map-reference.md)
...
+ Utilidades {#utilites}
   + [Resumen de utilidades](utilities/utilities.md)
   + Utilidades del servicio de imágenes {#image-serving-utilities}
      + [Utilidades del servicio de imágenes](is-api/is-utils/utilities/c-utils-home.md)
   ...
   + Convertidor de viñetas (vntc){#vignette-converter-vntc}
      ...
      + [Opciones para viñetas](ir-api/vntc/utilities/c-ir-vignette-converter-vntc/r-ir-options-for-vignettes.md)
