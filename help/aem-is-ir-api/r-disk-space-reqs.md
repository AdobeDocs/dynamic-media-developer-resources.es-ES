...
<table id="table_89995BECF30243569954819D07DA2A2F"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> <p>Compresión del JPEG </p> </td> 
   <td> <p> 1 (típico de la calidad de JPEG 95) </p> </td> 
  </tr> 
 </tbody> 
</table>
...
Una implementación de servicio de imágenes espera utilizar 30 000 imágenes heredadas de baja resolución, con un tamaño promedio de 500 x 500 píxeles RGB. Se espera que se añadan nuevos datos de imagen de calidad de impresión a una tasa de 10.000 al año. El tamaño típico de la imagen CMYK es de 4 k x 6 kB bytes. Todos los datos son JPEG comprimidos de alta calidad. La cantidad total de espacio en disco después de 3 años de uso se estima de la siguiente manera:
