...
seo-description: Crea una copia de un recurso de imagen existente. Los comandos de protocolo de Image Server especificados se aplican para generar la nueva copia
seo-title: copyImage
