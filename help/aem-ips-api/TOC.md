...
+ Data types {#data-types}
   ...
   + [InformaciónDeGabinete](types/c-data-types/r-cabinet-info.md)
   ...
   + [Campo de metadatos](types/c-data-types/r-metadata-field.md)
   ...
   + [DescompressOptions](types/c-data-types/r-uncompress-options.md)
...
+ Constantes de cadena {#sting-constants}
   ...
   + [Modos de nombres de capas de Photoshop](string-constants/c-string-constants/r-photoshop-layer-naming-modes.md)
   ...
   + [Campos de filtro de caracteres del usuario](string-constants/c-string-constants/r-user-char-filter-fields.md)
   + [Funciones del usuario](string-constants/c-string-constants/r-user-roles.md)
   + [Campos de ordenación del usuario](string-constants/c-string-constants/r-user-sort-fields.md)
...
+ [Cargando recursos mediante HTTP POST en UploadFile...](c-http-post.md)
