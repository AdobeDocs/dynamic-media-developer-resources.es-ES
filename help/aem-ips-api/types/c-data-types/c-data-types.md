...
+ [MatrizCamposMetadatosRecurso](r-asset-metadata-fields-array.md)
...
+ [OpcionesAdministraciónDeColor](r-color-management-options.md)
+ [Empresa](r-company.md)
+ [CompanyArray](r-company-array.md)
+ [MiembroCompañía](r-company-member.md)
+ [CompanyMemberArray](r-company-member-array.md)
+ [Pertenencia a empresa](r-company-membership.md)
...
+ [ConfiguraciónDeEmpresa](r-company-settings.md)
...
+ [Opciones de Illustrator](r-illustrator-options.md)
...
+ [OpcionesDeMedios](r-media-options.md)
+ [Metadatos](r-metadata.md)
...
+ [TrabajoProgramado](r-scheduled-job.md)
...
+ [DescomprimirOpciones](r-uncompress-options.md)
