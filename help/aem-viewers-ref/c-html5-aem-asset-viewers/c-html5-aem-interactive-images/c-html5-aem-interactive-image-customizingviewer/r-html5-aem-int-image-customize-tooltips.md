...
>[!NOTE]
>
>En caso de que los estilos de información del objeto se personalicen desde la página web en la que se incorpora, todas las propiedades deben contener `!IMPORTANT` regla. Esto no es necesario si la información del objeto se personaliza en el archivo CSS del visor.
