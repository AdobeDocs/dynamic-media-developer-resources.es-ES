...
<table id="table_D4A2035B65B140F882F550B711BD3160"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Déclencheur cuando se completa la inicialización del visor y se crean todos los componentes internos, de modo que se pueda utilizar <span class="codeph"> getComponent() </span> API. El controlador de devolución de llamada no toma ningún argumento. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> Déclencheur cada vez que se produce un evento dentro del visor, que puede gestionar un sistema de seguimiento de eventos, como Adobe Analytics. El controlador de devolución de llamada acepta los siguientes argumentos: </p> <p> 
     <ul id="ul_8A5F409E32E94063AE8D3AB158A0E13D"> 
      ...
      <li id="li_3BE8001365714C3FAC32C9B2CFFD5DCE"> <p> <span class="codeph"> instName {String} </span> : un nombre de instancia del componente SDK de visor que activó el evento. </p> </li> 
