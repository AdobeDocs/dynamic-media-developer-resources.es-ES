 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> Modificadores de servicio de imágenes que controlan el aspecto de la imagen de póster. Si se especifica en la dirección URL, codificar HTTP lo siguiente: </p> <p> 
     ...
     </ul> </p> <p> Este modificador funciona para el contenido de vídeo alojado en Dynamic Media Classic o AEM Dynamic Media. </p> <p>Para evitar que se muestre la imagen de póster predeterminada, especifique <span class="codeph"> ninguno</span> como valor de imagen de póster. </p> </td> 
  </tr> 
 </tbody> 
</table>
