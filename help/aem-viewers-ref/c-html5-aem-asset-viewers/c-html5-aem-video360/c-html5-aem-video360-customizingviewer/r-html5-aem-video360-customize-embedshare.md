...
**Ejemplo** : para configurar un área de cuadro de diálogo principal con una altura de 300 píxeles, un margen de diez píxeles y un fondo blanco:
...
Las etiquetas de los cuadros de diálogo se pueden localizar. Consulte [Localización de los elementos de la interfaz de usuario](../../../c-html5-aem-asset-viewers/c-html5-aem-video360/c-html5-aem-video360-localization.md#concept-16262b8096474d6c9c018c3e99110dd1) para obtener más información.
...
**Ejemplo** : para configurar el código incrustado y utilizar el ajuste de  `break-word` palabras:
...
**Ejemplo** : para establecer que los campos de entrada de tamaño personalizado tengan un borde gris de un píxel, un margen, un margen y un margen de 70 píxeles de ancho:
...
La información del objeto de botón se puede localizar. Consulte [Localización de los elementos de la interfaz de usuario](../../../c-html5-aem-asset-viewers/c-html5-aem-video360/c-html5-aem-video360-localization.md#concept-16262b8096474d6c9c018c3e99110dd1) para obtener más información.
