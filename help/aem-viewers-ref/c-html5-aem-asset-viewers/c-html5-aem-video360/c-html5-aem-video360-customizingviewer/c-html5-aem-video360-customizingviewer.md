---
title: Personalizar el visor Video360
description: Toda la personalización visual y la mayor parte de la personalización del comportamiento para el Visor de Video360 se realiza creando un CSS personalizado.
keywords: adaptable
...
Toda la personalización visual y la mayor parte de la personalización del comportamiento para el Visor de Video360 se realiza creando un CSS personalizado.
...
El visor admite dos mecanismos para crear CSS diseñadas de forma interactiva: marcadores CSS y consultas de medios CSS estándar. Puede utilizar marcadores o consultas de forma independiente o conjunta.
...
A continuación se muestra la documentación de referencia de los elementos de la interfaz de usuario que se aplica al visor de Video360:
