...
**Ejemplo** : para configurar un botón de uso compartido de Twitter de 28 x 28 píxeles, muestra una imagen diferente para cada uno de los cuatro estados de botón diferentes:
