...
**Ejemplo** : para configurar un botón de pantalla completa de 32 x 32 píxeles y colocarlo 6 píxeles desde el borde superior y derecho de la barra de control. Además, muestre una imagen diferente para cada uno de los cuatro estados de botón diferentes cuando esté seleccionado o no.
