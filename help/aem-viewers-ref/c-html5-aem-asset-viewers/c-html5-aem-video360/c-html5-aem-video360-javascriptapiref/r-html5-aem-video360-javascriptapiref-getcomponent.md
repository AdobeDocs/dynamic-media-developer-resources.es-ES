...
Al trabajar con las API de SDK, es importante usar un espacio de nombres de SDK correcto y completo, tal como se describe en [espacio de nombres de SDK de visor](../../../c-html5-aem-asset-viewers/c-html5-aem-video360/c-html5-aem-video360-viewer-sdk-namespace.md#concept-4ee8657c7d67421f8e7880130a246621).

Consulte la *documentación de la API del SDK de visor de HTML5* para obtener más información sobre un componente en particular.
