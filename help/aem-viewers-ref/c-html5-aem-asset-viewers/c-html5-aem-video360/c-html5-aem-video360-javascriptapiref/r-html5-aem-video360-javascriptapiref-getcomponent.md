...
Cuando se trabaja con API de SDK, es importante utilizar una Área de nombres de SDK completa y correcta, tal como se describe en [Área de nombres de SDK de visor](../../../c-html5-aem-asset-viewers/c-html5-aem-video360/c-html5-aem-video360-viewer-sdk-namespace.md#concept-4ee8657c7d67421f8e7880130a246621).

Consulte la documentación de la *API de SDK de visor HTML5* para obtener más información sobre un componente concreto.
