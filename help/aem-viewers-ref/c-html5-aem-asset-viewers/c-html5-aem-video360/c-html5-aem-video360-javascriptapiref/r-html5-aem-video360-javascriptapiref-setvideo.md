...
Define un nuevo vídeo externo. Se puede llamar en cualquier momento, tanto antes como después `init()`. Si se llama después `init()`, el visor intercambia el vídeo en tiempo de ejecución.
