...
Al trabajar con las API de SDK, es importante utilizar un espacio de nombres de SDK completo correcto, tal como se describe en [Espacio de nombres del SDK de visor](../../../c-html5-aem-asset-viewers/c-html5-aem-panoramic/c-html5-aem-panoramic-viewer-sdk-namespace.md#concept-4ee8657c7d67421f8e7880130a246621).
