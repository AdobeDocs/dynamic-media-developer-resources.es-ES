...
Al trabajar con las API de SDK, es importante usar el espacio de nombres de SDK correcto y completo, tal como se describe en [Espacio de nombres de SDK de visor](../../../c-html5-aem-asset-viewers/c-html5-aem-carousel/c-html5-aem-carousel-namespace.md).
