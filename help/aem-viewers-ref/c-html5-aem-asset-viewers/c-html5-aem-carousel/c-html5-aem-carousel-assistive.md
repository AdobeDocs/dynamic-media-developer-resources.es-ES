...
Los botones que permiten desplazarse por las diapositivas de carrusel tienen etiquetas que se actualizan en tiempo de ejecución en función de la diapositiva seleccionada. La plantilla de la etiqueta de este botón se establece con el símbolo `CAROUSELVIEWER_TOOLTIP_GOTO` de localización.
