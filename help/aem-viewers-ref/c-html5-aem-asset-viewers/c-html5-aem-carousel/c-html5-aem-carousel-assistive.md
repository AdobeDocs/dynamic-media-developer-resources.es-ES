...
Los botones que permiten navegar por las diapositivas de carrusel tienen etiquetas que se actualizan en tiempo de ejecución en función de la diapositiva seleccionada actualmente. La plantilla para la etiqueta de estos botones se establece con el símbolo de localización `CAROUSELVIEWER_TOOLTIP_GOTO`.
