---
description: Al tocar o hacer clic en este botón, el usuario regresa a la diapositiva anterior del conjunto de carrusel. Este botón no se muestra en dispositivos táctiles. Puede cambiar el tamaño, el aspecto y la posición de este botón mediante CSS.
seo-description: Al tocar o hacer clic en este botón, el usuario regresa a la diapositiva anterior del conjunto de carrusel. Este botón no se muestra en dispositivos táctiles. Puede cambiar el tamaño, el aspecto y la posición de este botón mediante CSS.
seo-title: Diapositiva anterior
...
Al tocar o hacer clic en este botón, el usuario regresa a la diapositiva anterior del conjunto de carrusel. Este botón no se muestra en dispositivos táctiles. Puede cambiar el tamaño, el aspecto y la posición de este botón mediante CSS.
...
<table id="table_94EE3F5BBE4547C0B4943471CEE7EDE4"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Posición desde la izquierda del borde del visor. </p> </td> 
  </tr> 
  <tr> 
...
Ejemplo: para configurar un botón de diapositiva anterior de 60 x 60 píxeles, situado a 10 píxeles del borde izquierdo del visor y centrado verticalmente, y muestra una imagen diferente para cada uno de los cuatro estados de botón diferentes.
