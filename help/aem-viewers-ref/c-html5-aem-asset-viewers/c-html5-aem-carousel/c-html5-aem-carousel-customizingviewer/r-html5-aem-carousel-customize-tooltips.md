...
>[!NOTE]
>
>En caso de que los estilos de información del objeto se personalicen desde la página web en la que se incorpora, todas las propiedades deben contener la regla `!IMPORTANT`. Este paso no es necesario si la información del objeto se personaliza en el archivo CSS del visor.

Ejemplo: para configurar la información del objeto que tiene un borde gris con un radio de esquina de 3 píxeles, un fondo negro y texto blanco en Arial®, tamaño de 11 píxeles:
