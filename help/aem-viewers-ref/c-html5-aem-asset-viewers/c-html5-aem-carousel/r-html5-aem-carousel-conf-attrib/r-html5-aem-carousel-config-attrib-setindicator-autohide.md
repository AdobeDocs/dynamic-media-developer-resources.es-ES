 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> Configura el comportamiento de ocultar automáticamente según el número de páginas y el tamaño del componente en tiempo de ejecución. </p> <p> <span class="codeph"> 0</span> desactiva la ocultación automática. </p> <p> <span class="codeph"> 1</span> habilita la ocultación automática. El componente oculta sus puntos si al menos una de las siguientes condiciones se vuelve verdadera: </p> <p> 
     ...
     </ul> </p> <p> Si se establece el límite <span class="codeph"><span class="varname"> </span></span> en <span class="codeph"> -1</span>, se deshabilita la segunda condición de ocultación automática. </p> </td> 
  </tr> 
 </tbody> 
</table>
