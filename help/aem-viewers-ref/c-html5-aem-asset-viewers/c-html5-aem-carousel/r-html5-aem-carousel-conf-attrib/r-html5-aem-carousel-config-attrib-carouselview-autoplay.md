...
<table id="table_441553CD34C94A58A9D7CBF772DEDDB6"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> Especifica la activación o desactivación, la duración para mostrar cada titular en el carrusel y la dirección del bucle automático. </p> <p>Configure como. <span class="codeph"> 0</span> para la desactivación del bucle automático. </p> <p>Establecer <span class="codeph"> 1</span> para activar el bucle automático con la duración de la transición en segundos controlada por <span class="codeph"> duration</span>. </p> <p>La dirección del bucle automático se controla con <span class="codeph"> dirección</span>. El <span class="codeph"> dirección</span> tiene el intervalo entre <span class="codeph"> 1</span> de derecha a izquierda y <span class="codeph"> 0</span> de izquierda a derecha. </p> </td> 
  </tr> 
 </tbody> 
</table>
