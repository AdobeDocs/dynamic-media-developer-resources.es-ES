...
El efecto de icono admite `state` selector de atributos. El atributo `state="play"` se utiliza cuando el vídeo se pone en pausa en mitad de la reproducción y `state="replay"` se utiliza cuando el cabezal de reproducción está al final del flujo.
