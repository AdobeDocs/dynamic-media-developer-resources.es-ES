...
Para configurar un botón de uso compartido de Facebook de 28 x 28 píxeles y que muestre una imagen diferente para cada uno de los cuatro estados de botón diferentes:
