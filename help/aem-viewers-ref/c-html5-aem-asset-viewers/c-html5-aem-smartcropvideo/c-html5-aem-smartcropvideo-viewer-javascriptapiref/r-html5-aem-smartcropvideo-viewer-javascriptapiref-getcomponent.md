...
Al trabajar con las API de SDK, es importante usar el espacio de nombres de SDK correcto y completo, tal como se describe en el espacio de nombres de SDK de [Viewer]
