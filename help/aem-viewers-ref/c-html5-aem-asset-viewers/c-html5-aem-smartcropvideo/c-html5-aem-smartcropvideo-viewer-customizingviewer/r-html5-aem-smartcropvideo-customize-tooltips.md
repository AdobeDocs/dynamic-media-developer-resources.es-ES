...
>[!NOTE]
>
>Si los estilos de la información sobre herramientas se personalizan desde la página web en la que se incorpora, todas las propiedades deben contener una regla `!IMPORTANT`. Esta regla no es necesaria si la información de objeto se personaliza en el archivo CSS del visor.
