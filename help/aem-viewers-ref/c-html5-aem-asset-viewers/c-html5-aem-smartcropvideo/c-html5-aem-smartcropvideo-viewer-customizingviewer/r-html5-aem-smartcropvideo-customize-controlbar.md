...
La barra de control siempre tiene la anchura total del visor disponible. CSS permite cambiar el color, la altura y la posición vertical con respecto al contenedor del visor de recorte inteligente de vídeo.
