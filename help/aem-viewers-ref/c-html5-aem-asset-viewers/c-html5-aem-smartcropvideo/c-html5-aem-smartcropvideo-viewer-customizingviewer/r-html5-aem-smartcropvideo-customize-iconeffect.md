...
El efecto de icono admite el selector de atributos `state`. `state="play"` se usa cuando el vídeo se pone en pausa en mitad de la reproducción y `state="replay"` cuando el cabezal de reproducción está al final del flujo.
