...
* Se ha agregado compatibilidad con pantallas de alta resolución para los visores flotantes, zoomVerticalViewer y MixedMediaViewer (al usar el zoom en línea).
