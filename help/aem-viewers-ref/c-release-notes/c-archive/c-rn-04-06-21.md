...
* Se ha actualizado la marca del producto a visores de Adobe Experience Platform.
...
* Se han corregido informes incorrectos del tiempo de reproducción de vídeo actual como NaN.<!--  (CQ-4310148) -->
...
* La imagen del póster no se muestra en el explorador Microsoft® Edge por primera vez.
