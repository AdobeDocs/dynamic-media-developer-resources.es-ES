...
description: Notas de la versión de visores de Scene7 5.5.2
...
* La imagen de póster puede encontrar un error `max size`. Es posible que tenga que aumentar la configuración de límite para la publicación del servicio de imágenes.
