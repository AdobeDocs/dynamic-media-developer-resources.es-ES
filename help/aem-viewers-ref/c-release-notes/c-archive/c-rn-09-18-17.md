...
* El valor `native` de `playback` está en desuso; usar el nuevo valor `progressive` en su lugar.
...
## Problemas y restricciones conocidos de la versión 5.8.2 {#section-af67bc1734844f31a89a09004b558c6e}
...
* La imagen de póster puede encontrarse con un `max size` error. Aumente la configuración de límite para la publicación de servicio de imágenes.
