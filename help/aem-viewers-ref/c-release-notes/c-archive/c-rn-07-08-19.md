...
## Nuevas funciones y mejoras para 5.15.1 {#section-f55c5ff7f6d0406c8739de4981dd7195}

* Se ha añadido la compatibilidad con la integración con la extensión de visores de Dynamic Media de Adobe Launch.
* Compatibilidad añadida con el modo de operación VR en el navegador oculto para el visor de vídeo360º.
* Evento añadido `RolloverKeyEvent.HREF_ACTIVATED` para permitir que el código de cliente responda a la activación de mapa de imagen en eCatalogViewer y eCatalogSearchViewer.
