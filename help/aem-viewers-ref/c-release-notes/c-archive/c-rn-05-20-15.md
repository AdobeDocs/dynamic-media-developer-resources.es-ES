---
description: Notas de la versión de Scene7 Viewer 5.2.3
...
* Los subtítulos de vídeo requieren un conjunto de reglas de compañía si están alojando una página HTML que se suministra desde un servidor externo que no es un servidor Dynamic Media. Póngase en contacto con el servicio de asistencia técnica del Adobe para obtener ayuda.
