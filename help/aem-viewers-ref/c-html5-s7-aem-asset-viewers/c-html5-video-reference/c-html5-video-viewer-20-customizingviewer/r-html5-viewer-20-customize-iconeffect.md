...
El efecto Icono admite la variable `state` selector de atributos. When `state="play"` se utiliza cuando el vídeo está en pausa en mitad de la reproducción, y `state="replay"` se utiliza cuando el cabezal de reproducción está al final del flujo.
