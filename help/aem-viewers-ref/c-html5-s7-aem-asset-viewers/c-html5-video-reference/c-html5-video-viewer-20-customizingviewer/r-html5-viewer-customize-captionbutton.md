...
Para configurar un botón de subtítulo cerrado de 28 x 28 píxeles y colocado a cuatro píxeles de la parte superior y a 68 píxeles del borde derecho de la barra de control. Y, por último, muestra una imagen diferente para cada uno de los cuatro estados de botón cuando se selecciona o no se selecciona.
