...
Al trabajar con las API de SDK, es importante utilizar un área de nombres de SDK completa como se describe en [Espacio de nombres del SDK de visor](../../../c-html5-s7-aem-asset-viewers/c-html5-20-zoom-viewer-about/c-html5-20-zoom-viewer-namespace.md#concept-53e47e46d7954e2b9681d13d716fd1ca).
...
`{Object}` : referencia al componente SDK de visor. El método devuelve `null` si la variable `componentId` no es un componente de visor compatible o si la lógica del visor aún no ha creado el componente.
