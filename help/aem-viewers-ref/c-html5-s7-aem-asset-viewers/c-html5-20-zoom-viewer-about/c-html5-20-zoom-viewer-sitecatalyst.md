...
El visor de vídeo admite [!DNL Adobe Analytics] el seguimiento predeterminado. Para habilitar el seguimiento, pase el nombre de ajuste preestablecido de compañía correcto como `config2` parámetro.
