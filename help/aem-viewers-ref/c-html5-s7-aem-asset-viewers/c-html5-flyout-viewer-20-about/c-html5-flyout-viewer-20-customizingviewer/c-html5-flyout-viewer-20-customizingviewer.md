...
description: Personalización del visor flotante
keywords: adaptable
...
Toda la personalización visual y la mayoría de las personalizaciones de comportamiento se realizan creando una CSS personalizada.
...
Para ayudar a crear una CSS diseñada y adaptable, el visor admite marcadores CSS con clases CSS especiales asignadas dinámicamente al elemento contenedor del visor de nivel superior. La asignación se basa en el tamaño del visor en tiempo de ejecución y en el tipo de entrada utilizado en el dispositivo actual.
...
El segundo grupo de marcadores CSS incluye `.s7mouseinput` y `.s7touchinput`. El marcador `.s7touchinput` se establece si el dispositivo actual tiene capacidades de entrada táctil; de lo contrario, `.s7mouseinput` se utiliza. Estos marcadores están diseñados para crear elementos de entrada de interfaz de usuario con diferentes tamaños de pantalla para diferentes tipos de entrada, ya que la entrada táctil suele requerir elementos más grandes. En los casos en los que el dispositivo tiene funciones táctiles y de entrada de ratón, `.s7touchinput` y el visor presenta una interfaz de usuario táctil.

El siguiente ejemplo de CSS establece el tamaño del botón de zoom en 28 x 28 píxeles en sistemas con entrada de ratón y 56 x 56 píxeles en dispositivos táctiles. Además, oculta completamente el botón si el tamaño del visor se vuelve pequeño:
...
El uso de marcadores CSS es la forma más flexible de crear CSS adaptable. El motivo es que le permite dirigirse no solo al tamaño de la pantalla del dispositivo, sino también al tamaño real del visor, lo que puede resultar útil para los diseños interactivos de la página web.
...
Con un enfoque clásico del estilo, el CSS tendría una referencia independiente al archivo de imagen individual en el servidor para cada estado del elemento de la interfaz de usuario. El siguiente es un ejemplo de CSS para aplicar estilo al botón de desplazamiento:
...
A continuación se muestra la documentación de referencia de elementos de la interfaz de usuario que se aplica al visor flotante:

* [Vista de zoom flotante](r-html5-flyout-viewer-20-customize-flyoutzoomview.md)
* [Enfoque resaltado](r-html5-flyout-viewer-20-customize-focushighlight.md)
* [Área del visor principal](r-html5-flyout-viewer-20-customize-mainviewerarea.md)
* [Muestras](r-html5-flyout-viewer-20-customize-swatches.md)
* [Información sobre herramientas](r-html5-flyout-viewer-20-customize-tooltips.md)
