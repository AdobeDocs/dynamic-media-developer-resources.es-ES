...
>[!NOTE]
>
>Este botón es compatible con los selectores de atributos `state` y `selected`, que pueden utilizarse para aplicar diferentes aspectos a diferentes estados de botones.
>
>En particular, `selected='false'` corresponde al estado inicial del botón de desplazamiento y `selected='true'` corresponde al estado cuando el panel de búsqueda está activo.
...
Ejemplo: para configurar un botón de búsqueda de 28 x 28 píxeles y mostrar una imagen diferente para cada uno de los cuatro estados de botón diferentes cuando se selecciona o no.
