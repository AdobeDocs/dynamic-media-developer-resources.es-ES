...
Ejemplo: para configurar el encabezado del cuadro de diálogo con relleno, icono de 24 x 17 píxeles y título en negrita de 16 puntos. Finalmente, un botón Cerrar de 28 x 28 píxeles colocó dos píxeles desde la parte superior y dos píxeles desde la parte derecha del contenedor de cuadro de diálogo:
...
La información del objeto de este botón se puede localizar. Consulte [Localización de los elementos de la interfaz de usuario](../../../c-html5-s7-aem-asset-viewers/c-html5-ecatsearch-viewer-about/c-html5-ecatsearch-viewer-localization.md#concept-cbfc39344c494eb7b9f6a272cff0cc74) para obtener más información.
...
Ejemplo: Configurar un formulario para que tenga un borde gris de un píxel con nueve píxeles de relleno alrededor de todos los campos de entrada. Tener el mismo borde en color rojo para los campos en los que se ha producido un error en la validación. Y finalmente, para tener 250 píxeles de ancho en el campo To, y el resto de los campos de entrada 300 píxeles de ancho:
...
Cuando un usuario introduce datos de entrada incorrectos y la validación en línea falla, se muestra un mensaje en la parte superior del cuerpo del cuadro de diálogo. Este mensaje también aparece cuando el cuadro de diálogo debe mostrar un error o un mensaje de confirmación cuando se envía el formulario. Se controla con el siguiente selector de clase CSS:
...
La información del botón se puede localizar.
