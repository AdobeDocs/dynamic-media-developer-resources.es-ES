...
Ejemplo: para configurar un botón grande de página siguiente de 56 x 56 píxeles, centrado verticalmente y anclado al borde derecho del visor, muestra una imagen diferente para cada uno de los cuatro estados de botón diferentes.
