...
seo-description: La herramienta Imprimir consiste en un botón agregado a la barra de control y el cuadro de diálogo modal que se muestra cuando se activa la herramienta.
seo-title: Imprimir
...
Ejemplo: Para configurar un botón de impresión de 28 x 28 píxeles y mostrar una imagen diferente para cada uno de los cuatro estados de botón diferentes.
...
De forma predeterminada, el cuadro de diálogo modal se muestra centrado en la pantalla en los sistemas de escritorio. El componente gestiona la colocación y el tamaño del cuadro de diálogo. El cuadro de diálogo se controla con el siguiente selector de clase CSS:
...
Ejemplo: para configurar un cuadro de diálogo con un fondo gris:
...
Se pueden localizar la información del botón Cerrar y el título del cuadro de diálogo. Consulte [Localización de los elementos de la interfaz de usuario](../../../c-html5-s7-aem-asset-viewers/c-html5-ecatsearch-viewer-about/c-html5-ecatsearch-viewer-localization.md#concept-cbfc39344c494eb7b9f6a272cff0cc74) para obtener más información.

Ejemplo: para configurar el encabezado del cuadro de diálogo con relleno, el icono de 22 x 22 píxeles, el título de 16 puntos en negrita y el botón Cerrar de 28 x 28 píxeles se han colocado dos píxeles desde la parte superior y dos píxeles desde el contenedor derecho del cuadro de diálogo:
...
Ejemplo: para configurar un pie de página del cuadro de diálogo con el botón Cancelar 64 x 34 y el botón Enviar a imprimir 96 x 34, con el color de texto y el color de fondo diferentes para cada estado del botón:
...
<table id="table_3FF4691D848A4C4D8EF060B7E79DEEDE"> 
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> height  </span> </p> </td> 
   <td colname="col2"> <p> Altura del área del cuadro de diálogo principal. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> background-color  </span> </p> </td> 
...
Los controles de entrada se envuelven en el contenedor y se controlan con el siguiente selector de clase CSS:
...
Ejemplo: para definir un margen de 30 píxeles desde el borde izquierdo del cuadro de diálogo.
...
Los botones de radio y el texto de sus rótulos se controlan con el siguiente selector de clase CSS:
...
Los selectores numéricos para la selección de rango de impresión se controlan con el siguiente selector de clase CSS

```
.s7ecatalogsearchviewer .s7printdialog .s7dialogrange
```

**Propiedades CSS del rango de impresión del cuadro de diálogo**
...
Ejemplo: para configurar todos los botones de radio para que tengan una anchura de 150 píxeles con texto en negro, un espaciado de diez píxeles y un selector numérico de 42 píxeles de ancho:
...
El divisor horizontal entre la selección del rango de páginas y las secciones del diseño de impresión se controla con el siguiente selector de clase CSS:
...
<table id="table_AB42F1DC92BB4946868F0A9FE86ABAA6"> 
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> borde </span> </p> </td> 
   <td colname="col2"> <p> Borde alrededor del separador. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> relleno </span> </p> </td> 
   <td colname="col2"> <p>Relleno interior. </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> width  </span> </p> </td> 
   <td colname="col2"> <p>Ancho del divisor. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> margin  </span> </p> </td> 
   <td colname="col2"> <p>Margen exterior </p> </td> 
...
Ejemplo: para configurar un divisor gris de 430 píxeles de ancho con un margen vertical de 10 píxeles en ambos lados y un margen de diez píxeles en la parte superior:
