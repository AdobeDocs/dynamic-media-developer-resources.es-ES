...
description: La tabla de contenido es un botón de la barra de control principal. Cuando se activa, aparece un panel desplegable con una lista de índices y etiquetas de página.
...
La tabla de contenido es un botón de la barra de control principal. Cuando se activa, aparece un panel desplegable con una lista de índices y etiquetas de página.
