...
Ejemplo: para configurar un botón de primera página de 28 x 28 píxeles y posicionado 4 píxeles desde la parte inferior y 220 píxeles desde el borde izquierdo de la barra de control principal. Finalmente, muestra una imagen diferente para cada uno de los cuatro estados de botones diferentes.
