...
description: Al seleccionar este botón se restablece el visualizador entre la vista principal y las miniaturas. Este botón aparece en la barra de control principal. Puede cambiar el tamaño, la apariencia y la posición de este botón mediante CSS.
