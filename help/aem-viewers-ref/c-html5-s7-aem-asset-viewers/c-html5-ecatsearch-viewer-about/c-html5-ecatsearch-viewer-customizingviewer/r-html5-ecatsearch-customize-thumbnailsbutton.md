...
description: Al seleccionar este botón, se restablece el visor entre la vista principal y las miniaturas. Este botón aparece en la barra de control principal. Puede cambiar el tamaño, el aspecto y la posición de este botón mediante CSS.
...
Al seleccionar este botón, se restablece el visor entre la vista principal y las miniaturas. Este botón aparece en la barra de control principal. Puede cambiar el tamaño, el aspecto y la posición de este botón mediante CSS.
...
Ejemplo: para configurar un botón de miniaturas de 28 x 28 píxeles y colocado 4 píxeles desde la parte inferior y 5 píxeles desde el borde izquierdo de la barra de control principal. Finalmente, muestra una imagen diferente para cada uno de los cuatro estados de botón diferentes cuando se selecciona o no.
