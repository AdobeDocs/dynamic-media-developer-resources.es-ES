...
<table id="table_BE34F807437C4955A2A640495E05138F"> 
 <tbody> 
  <tr> 
   ...
   <td> <p> Cuando se establece en <span class="codeph"> 1</span>A continuación, el componente rellena el panel desplegable con elementos para todas las páginas, incluso las que no tienen etiquetas definidas. </p> <p>Cuando se establece en <span class="codeph"> 0</span> en el panel desplegable solo se muestran los elementos con etiquetas explícitas. </p> </td> 
  </tr> 
 </tbody> 
</table>
