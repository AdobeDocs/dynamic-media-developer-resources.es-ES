---
title: Referencia de la API de JavaScript para el visor de búsqueda en catálogo electrónico
description: La clase principal del Visor de búsqueda en catálogo electrónico es eCatalogSearchViewer. Se declara en el área de nombres de s7viewers. Esta API de JavaScript cubre el constructor, los métodos y las llamadas de retorno de esta clase en particular.
...
# Referencia de la API de JavaScript para el visor de búsqueda en catálogo electrónico{#javascript-api-reference-for-ecatalog-search-viewer}
