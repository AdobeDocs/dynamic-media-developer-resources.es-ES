...
Al trabajar con las API de SDK, es importante utilizar un espacio de nombres de SDK correcto y completo, tal como se describe en [Espacio de nombres del SDK de visor](../../../c-html5-s7-aem-asset-viewers/c-html5-20-ecatalog-viewer-about/c-html5-20-ecatalog-html5-viewer-sdk-namespace.md#concept-16ce67bfbdc64ffc8fc7ad174f208f05).

Consulte la *API de SDK de visor* para obtener más información sobre un componente en particular.
