...
<table id="table_58C40353B7244335872350C98DF2CFB3"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Etiqueta de página generada por el visor en tiempo de carga. </p> <p>El nombre de ese símbolo es una plantilla, donde <span class="codeph"> XX </span> es un índice de pliego basado en cero en orientación horizontal, y <span class="codeph"> YY opcional </span> es un índice de página basado en cero dentro del pliego dirigido por <span class="codeph"> XX </span>. </p> <p>Se aplica únicamente al recurso cargado inicialmente; se omite si se cambia un recurso mediante la llamada <span class="codeph"> de API setAsset() </span> . </p> </td> 
  </tr> 
  <tr> 
