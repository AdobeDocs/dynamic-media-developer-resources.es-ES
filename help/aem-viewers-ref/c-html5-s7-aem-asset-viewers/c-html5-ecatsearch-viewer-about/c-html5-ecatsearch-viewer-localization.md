...
<table id="table_58C40353B7244335872350C98DF2CFB3"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Mensaje localizado que se muestra dentro del cuadro de entrada de búsqueda antes de que el usuario empiece a introducir el texto de búsqueda. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> SearchPanel.INFO_PROMPT </span> </p> </td> 
   <td colname="col2"> <p>Se muestra un mensaje localizado cuando se abre el panel de búsqueda por primera vez, sugiriendo al usuario que realice la búsqueda. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> SearchPanel.INFO_NO_RESULTS </span> </p> </td> 
   <td colname="col2"> <p>Se muestra un mensaje localizado cuando la búsqueda no arrojó ningún resultado. </p> <p>Este símbolo admite el siguiente token de reemplazo en tiempo de ejecución: <span class="codeph"> $SEARCH_TEXT$ </span>. El componente lo reemplaza por el texto de búsqueda introducido por el usuario. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Define un valor del atributo ARIA-label <span class="codeph"> de </span> para todo el panel de búsqueda. </p> </td> 
  </tr> 
 </tbody> 
</table>
