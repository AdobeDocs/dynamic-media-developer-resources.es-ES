---
description: Cierto contenido que muestra el visor de catálogos electrónicos está sujeto a localización, incluidos los botones de zoom, los botones de cambio de página, el botón de miniatura, el botón de pantalla completa, el botón de cierre y los botones de barra de desplazamiento.
seo-description: Cierto contenido que muestra el visor de catálogos electrónicos está sujeto a localización, incluidos los botones de zoom, los botones de cambio de página, el botón de miniatura, el botón de pantalla completa, el botón de cierre y los botones de barra de desplazamiento.
...
Cierto contenido que muestra el visor de catálogos electrónicos está sujeto a localización, incluidos los botones de zoom, los botones de cambio de página, el botón de miniatura, el botón de pantalla completa, el botón de cierre y los botones de barra de desplazamiento.
...
Se admiten los siguientes SÍMBOLOS (suponiendo que containerId es el ID del contenedor del visor):
...
<table id="table_58C40353B7244335872350C98DF2CFB3"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Botón de página siguiente grande. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> &lt;containerid&gt;_leftButton.PanLeftButton.TOOLTIP  </span> </p> </td> 
   <td colname="col2"> <p>Botón de página anterior grande. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Botón de primera página. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Botón de página siguiente. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> &lt;containerid&gt;_toolBarLeftButton.PanLeftButton.TOOLTIP  </span> </p> </td> 
   <td colname="col2"> <p>Botón de página anterior. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> ThumbnailPageButton.TOOLTIP_SELECTED  </span> </p> </td> 
   <td colname="col2"> <p>Botón Miniaturas en el modo de miniaturas. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> ThumbnailPageButton.TOOLTIP_UNSELECTED  </span> </p> </td> 
   <td colname="col2"> <p>Miniaturas en modo normal. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> CloseButton.TOOLTIP  </span> </p> </td> 
   <td colname="col2"> <p>Botón Cerrar. </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Botón de cierre del panel de información. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Encabezado del cuadro de diálogo Correo electrónico. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> EmailShare.TOOLTIP_HEADER_CLOSE  </span> </p> </td> 
   <td colname="col2"> <p>Cuadro de diálogo Correo electrónico, botón de cierre superior derecho. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> EmailShare.INVALID_ADDRESSS  </span> </p> </td> 
   <td colname="col2"> <p>Se muestra un mensaje de error en caso de que la dirección de correo electrónico esté mal formada. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Añadir otra dirección de correo electrónico. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Desde el campo de entrada. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> EmailShare.MESSAGE  </span> </p> </td> 
   <td colname="col2"> <p>Campo de entrada de mensajes. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Botón de envío de formulario. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Incrustar botón Compartir. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Cuadro de diálogo Incrustar botón de cierre superior derecho. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Imprimir encabezado de cuadro de diálogo. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> Print.TOOLTIP_HEADER_CLOSE  </span> </p> </td> 
   <td colname="col2"> <p>Botón de cierre superior derecho del cuadro de diálogo Imprimir. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> Print.PRINT_RANGE  </span> </p> </td> 
   <td colname="col2"> <p>Etiqueta de la sección "Seleccionar páginas de impresión". </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> Print.PRINT_RANGE_CURRENT  </span> </p> </td> 
   <td colname="col2"> <p>Rótulo del botón de radio "Páginas actuales". </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> Print.PRINT_RANGE_FROM  </span> </p> </td> 
   <td colname="col2"> <p>Rótulo del botón de radio "Intervalo de propagación desde". </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> Print.PRINT_RANGE_TO  </span> </p> </td> 
   <td colname="col2"> <p>Rótulo del selector numérico "to". </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> Print.PRINT_RANGE_ALL  </span> </p> </td> 
   <td colname="col2"> <p>Rótulo del botón de radio "Todas las páginas". </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> Print.PAGE_HANDLING  </span> </p> </td> 
   <td colname="col2"> <p>Etiqueta de la sección "Administración de páginas". </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> Print.PAGE_HANDLING_ONE  </span> </p> </td> 
   <td colname="col2"> <p>Rótulo del botón de radio "1 página por hoja". </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> Print.PAGE_HANDLING_TWO  </span> </p> </td> 
   <td colname="col2"> <p>Rótulo del botón de radio "2 páginas por hoja". </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Rótulo del botón Enviar a impresión </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> Print.TOOLTIP_ACTION  </span> </p> </td> 
   <td colname="col2"> <p> Botón Enviar a impresión. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Botón "Añadir favorito" en el modo de edición Favoritos. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> AddFavoriteButton.TOOLTIP_UNSELECTED  </span> </p> </td> 
   <td colname="col2"> <p>Botón "Añadir favorito" en modo normal. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Botón "Vista todos los favoritos" cuando la vista Favoritos está activa. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> ViewAllFavoriteButton.TOOLTIP_UNSELECTED  </span> </p> </td> 
   <td colname="col2"> <p>Botón "Vista todos los favoritos" cuando la vista Favoritos está inactiva. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> FavoritesEffect.TOOLTIP  </span> </p> </td> 
   <td colname="col2"> <p>Icono de un solo favorito. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> MediaSet.LABEL_XX[_YY]  </span> </p> </td> 
   <td colname="col2"> <p>Etiqueta de página generada por el visor en tiempo de carga. </p> <p>El nombre de ese símbolo es una plantilla, donde <span class="codeph"> XX </span> es un índice de propagación basado en cero en orientación horizontal, y el <span class="codeph"> AAAA </span> opcional es un índice de página basado en cero dentro del pliego dirigido por <span class="codeph"> XX </span>. </p> <p>Se aplica únicamente al recurso cargado inicialmente; se omite si se cambia un recurso mediante la llamada de API <span class="codeph"> setAsset() </span>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> MediaSet.LABEL_DELIM  </span> </p> </td> 
   <td colname="col2"> <p> Carácter utilizado como delimitador de etiquetas de página en caso de que las etiquetas se definan para las páginas izquierda y derecha dentro de un pliego. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> ScrollLeftRightButton.TOOLTIP_SELECTED  </span> </p> </td> 
   <td colname="col2"> <p>Botón de desplazamiento izquierdo de la barra de control principal. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> ScrollLeftRightButton.TOOLTIP_UNSELECTED  </span> </p> </td> 
   <td colname="col2"> <p>Botón derecho de desplazamiento de la barra de control principal. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> SearchPanel.PLACEHOLDER  </span> </p> </td> 
   <td colname="col2"> <p>Mensaje localizado que se muestra dentro del cuadro de entrada de búsqueda antes de que el usuario introduzca inicios en el texto de búsqueda. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> SearchPanel.INFO_PROMPT  </span> </p> </td> 
   <td colname="col2"> <p>Mensaje localizado que se muestra cuando se abre el panel de búsqueda por primera vez, sugiriendo al usuario que realice la búsqueda. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> SearchPanel.INFO_NO_RESULTS  </span> </p> </td> 
   <td colname="col2"> <p>Se muestra un mensaje localizado cuando la búsqueda no arrojó ningún resultado. </p> <p>Este símbolo admite el siguiente token de sustitución de tiempo de ejecución: <span class="codeph"> $SEARCH_TEXT$ </span>. El componente lo sustituye por el texto de búsqueda introducido por el usuario. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> SearchPanel.INFO_RESULTS  </span> </p> </td> 
   <td colname="col2"> <p>Se muestra un mensaje localizado cuando la búsqueda se ha completado correctamente y devuelve al menos un resultado. </p> <p>Este símbolo admite los siguientes tokens de reemplazo en tiempo de ejecución: </p> <p> 
     <ul id="ul_30B76EAB921848069BE843A5F91F697A"> 
      <li id="li_16AF3EFCC4BF4180B66DE5EA82CC77F4"> <span class="codeph"> $SEARCH_TEXT$  </span> - Texto de búsqueda introducido por el usuario. </li> 
      ...
      <li id="li_9EB7B41A989B455ABEC72E052284F117"> <span class="codeph"> $PAGE_COUNT$  </span> - El número de páginas de catálogo que contienen al menos una visita de búsqueda. </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> SearchPanel.THUMBNAIL_LABEL  </span> </p> </td> 
   <td colname="col2"> <p>Etiqueta localizada para la miniatura de resultados del panel de búsqueda. </p> <p>Este símbolo admite los siguientes tokens de reemplazo en tiempo de ejecución: </p> <p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Define un valor del atributo <span class="codeph"> aria-label </span> ARIA para todo el panel de búsqueda. </p> </td> 
  </tr> 
 </tbody> 
</table>
