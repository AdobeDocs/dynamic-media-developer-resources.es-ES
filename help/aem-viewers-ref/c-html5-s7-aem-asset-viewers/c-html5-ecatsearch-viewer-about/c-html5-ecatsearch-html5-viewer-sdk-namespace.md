...
Por ejemplo, si tiene pensado escuchar `StatusEvent.NOTF_VIEW_READY` evento y el visor se suministra desde Scene7 Publishing System, el tipo de evento completo es `s7classic.s7sdk.event.StatusEvent.NOTF_VIEW_READY`y el código de escucha de evento es similar al siguiente:
