...
Ejemplo: Para configurar un botón derecho de giro de 28 x 28 píxeles y colocado en el borde derecho del contenedor interno. Y, finalmente, muestra una imagen diferente para cada uno de los cuatro estados de botón diferentes:
