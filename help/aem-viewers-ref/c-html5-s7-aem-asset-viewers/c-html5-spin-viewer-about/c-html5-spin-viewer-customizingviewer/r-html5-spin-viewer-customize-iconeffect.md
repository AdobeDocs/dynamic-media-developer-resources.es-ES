...
El indicador de giro admite `state` selector de atributos configurado como `spin_1D` si hay un conjunto de giros unidimensionales, y a `spin_2D` si hay un conjunto de giros multidimensional.
