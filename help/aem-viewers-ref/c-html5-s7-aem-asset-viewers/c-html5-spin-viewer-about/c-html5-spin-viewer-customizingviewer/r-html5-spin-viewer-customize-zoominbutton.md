...
Al tocar o hacer clic en este botón, se amplía una imagen de la vista principal. Este botón no se muestra en los teléfonos móviles para ahorrar espacio en la pantalla. Puede cambiar el tamaño, la apariencia y la posición de este botón mediante CSS.
...
Ejemplo: Para configurar un botón de zoom de 32 x 32 píxeles y situado a seis píxeles de la parte superior y del borde derecho del visor. Y, finalmente, muestra una imagen diferente para cada uno de los cuatro estados de botón diferentes.
