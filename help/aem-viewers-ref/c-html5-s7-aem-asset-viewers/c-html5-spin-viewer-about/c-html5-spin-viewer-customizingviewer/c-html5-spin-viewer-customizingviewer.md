...
Para ayudarle a crear CSS diseñada y adaptable, el visor admite marcadores CSS con clases CSS especiales asignadas dinámicamente al elemento contenedor del visor de nivel superior. Estas clases se basan en el tamaño del visor en tiempo de ejecución y el tipo de entrada utilizado en el dispositivo actual.
