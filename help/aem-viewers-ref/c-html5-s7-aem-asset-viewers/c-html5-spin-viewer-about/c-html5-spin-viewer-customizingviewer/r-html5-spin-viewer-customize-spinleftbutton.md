...
seo-title: Botón Girar a la izquierda
...
Ejemplo: para configurar un botón izquierdo de giro de 28 x 28 píxeles, que se coloca en el borde izquierdo del contenedor interior, y que muestra una imagen diferente para cada uno de los cuatro estados de botón diferentes:
