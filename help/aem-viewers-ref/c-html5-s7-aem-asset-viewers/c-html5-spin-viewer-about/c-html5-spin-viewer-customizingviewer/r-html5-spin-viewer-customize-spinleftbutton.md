...
Ejemplo: para configurar un botón de giro izquierdo de 28 x 28 píxeles, que se sitúa en el borde izquierdo del contenedor interior y que muestra una imagen diferente para cada uno de los cuatro estados de botón diferentes:
