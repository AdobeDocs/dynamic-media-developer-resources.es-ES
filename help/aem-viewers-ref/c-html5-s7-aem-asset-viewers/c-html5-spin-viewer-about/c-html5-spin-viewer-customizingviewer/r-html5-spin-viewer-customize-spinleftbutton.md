...
Ejemplo: para configurar un botón izquierdo de giro de 28 x 28 píxeles y colocarlo en el borde izquierdo del contenedor interior. Finalmente, muestra una imagen diferente para cada uno de los cuatro estados de botón:
