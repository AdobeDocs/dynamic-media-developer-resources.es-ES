...
seo-description: Documentación de atributos de configuración para el visor de giros.
...
* `SpinView.zoomstep` (calificado con el nombre de clase de componente)
* `cont_spinView.zoomstep` (calificado con ID de componente, suponiendo `cont` que es el ID del elemento de contenedor)
