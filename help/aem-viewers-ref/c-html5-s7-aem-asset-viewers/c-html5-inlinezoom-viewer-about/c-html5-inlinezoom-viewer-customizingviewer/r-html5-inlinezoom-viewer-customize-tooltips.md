...
>[!NOTE]
>
>Si los estilos de la información sobre herramientas se personalizan desde la página web en la que se incorpora, todas las propiedades deben contener `!IMPORTANT` regla. Sin embargo, no es necesario si la información del objeto se personaliza en el archivo CSS del visor.
