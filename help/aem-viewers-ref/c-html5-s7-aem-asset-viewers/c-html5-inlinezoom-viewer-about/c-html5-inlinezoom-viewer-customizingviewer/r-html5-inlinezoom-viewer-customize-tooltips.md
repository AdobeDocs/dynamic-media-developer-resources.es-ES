...
>[!NOTE]
>
>En caso de que los estilos de información sobre herramientas se personalicen desde la página web de incrustación, todas las propiedades deben contener `!IMPORTANT` regla. Sin embargo, no es necesario si la información del objeto se personaliza en el archivo CSS del visor.
