...
Se recomienda utilizar la página de HTML predeterminada para el modo emergente llamado `FlyoutViewer.html`. Se encuentra bajo la [!DNL html5/] de la implementación estándar de Image Serving-Viewers:
...
1. Configuración del tamaño del visor.
   ...
   Consulte [Personalizar visor de zoom en línea](../../c-html5-s7-aem-asset-viewers/c-html5-inlinezoom-viewer-about/c-html5-inlinezoom-viewer-customizingviewer/c-html5-inlinezoom-viewer-customizingviewer.md#concept-82f8c71adbe54680a0c2f83f81e5f451) para obtener más información sobre cómo aplicar estilo al visor con CSS.
