...
Este modo es el más común para dispositivos móviles. La página web carga el visor mediante una llamada de `window.open()` JavaScript, un elemento `A` HTML configurado correctamente o de cualquier otra forma adecuada.

Se recomienda utilizar la página HTML lista para usar en el modo emergente denominado `FlyoutViewer.html`. Se encuentra en la [!DNL html5/] subcarpeta de la implementación estándar de servicio de imágenes y visores:
...
1. Configuración del tamaño del visor.
   ...
   Consulte [Personalización del visor](../../c-html5-s7-aem-asset-viewers/c-html5-inlinezoom-viewer-about/c-html5-inlinezoom-viewer-customizingviewer/c-html5-inlinezoom-viewer-customizingviewer.md#concept-82f8c71adbe54680a0c2f83f81e5f451) de zoom en línea para obtener más información sobre el estilo del visor con CSS.
...
* en lugar de definir un tamaño de visor fijo mediante unidades absolutas, utilice CSS que establezca el visor `width` y `height` en 100 % como se muestra a continuación:
