...
El código de página web debe pasar dicho objeto de localización al constructor del visor, como valor del `localizedTexts` campo del objeto de configuración. Una opción alternativa es pasar el objeto de localización llamando al `setLocalizedTexts(localizationInfo)` método .
