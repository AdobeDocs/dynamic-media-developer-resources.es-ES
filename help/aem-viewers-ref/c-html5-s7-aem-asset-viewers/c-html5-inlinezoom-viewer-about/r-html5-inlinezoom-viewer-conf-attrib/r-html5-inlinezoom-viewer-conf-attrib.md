...
Puede definir cualquier comando de configuración en la URL. O bien, puede utilizar `setParam()`o ambos `setParams()`métodos de API. También puede especificar cualquier atributo de configuración en el registro de configuración del lado del servidor.
