---
title: Botón Girar a la derecha
...
# Botón Girar a la derecha{#spin-right-button}

Al seleccionar este botón, la imagen se gira a la derecha en la vista principal. Este botón no se muestra en los teléfonos móviles para ahorrar espacio en la pantalla. Además, el botón se oculta cuando se utiliza un conjunto de giros multidimensional. Puede cambiar el tamaño, la apariencia y la posición del botón mediante CSS.
...
Ejemplo: Para configurar un botón derecho de giro de 28 x 28 píxeles y situado en el borde derecho del contenedor interno. Y, finalmente, muestra una imagen diferente para cada uno de los cuatro estados de botón diferentes:
