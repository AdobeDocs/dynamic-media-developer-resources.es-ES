...
Para ayudarle a crear CSS diseñada y adaptable, el visor admite marcadores CSS con clases CSS especiales asignadas dinámicamente al elemento contenedor del visor de nivel superior. Lo hace en función del tamaño del visor en tiempo de ejecución y del tipo de entrada utilizado en el dispositivo actual.
...
El uso de marcadores CSS es la forma más flexible de crear CSS adaptable. El motivo es que le permite segmentar no solo el tamaño de la pantalla del dispositivo, sino también el tamaño real del visor, lo que puede resultar útil para diseños de página de diseño interactivos.
