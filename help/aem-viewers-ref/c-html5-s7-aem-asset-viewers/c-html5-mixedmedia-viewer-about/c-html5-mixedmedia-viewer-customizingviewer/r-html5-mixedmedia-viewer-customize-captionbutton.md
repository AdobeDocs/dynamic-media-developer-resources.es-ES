...
>[!NOTE]
>
>Este botón admite el selector de `state` atributos y los selectores de atributos seleccionados, que pueden utilizarse para aplicar diferentes apariencias a distintos estados de botones. En concreto, `selected='true'` corresponde al estado cuando los rótulos están visibles y `selected='false'` se utilizan cuando los rótulos están ocultos.
