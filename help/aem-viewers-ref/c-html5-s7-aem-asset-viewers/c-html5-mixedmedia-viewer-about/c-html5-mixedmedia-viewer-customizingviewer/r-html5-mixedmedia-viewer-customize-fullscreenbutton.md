...
Este botón hace que el usuario introduzca o salga del modo de pantalla completa cuando lo selecciona. Se utiliza cuando el visor muestra imágenes o conjuntos de giros. Este botón no se muestra si el visor funciona en modo emergente y el sistema no admite pantalla completa nativa. Puede cambiar el tamaño, el aspecto y la posición de este botón mediante CSS.
