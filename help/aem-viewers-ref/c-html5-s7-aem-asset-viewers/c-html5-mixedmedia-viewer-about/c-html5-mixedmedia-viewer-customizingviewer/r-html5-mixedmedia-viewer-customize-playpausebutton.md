...
description: El botón de reproducción/pausa hace que el reproductor de vídeo reproduzca o ponga en pausa el contenido del vídeo cuando el usuario lo selecciona.
...
El botón Reproducir/Pausar hace que el reproductor de vídeo reproduzca o ponga en pausa el contenido del vídeo cuando el usuario lo selecciona.
...
>
>`replay='true'` Este atributo se establece cuando el vídeo ha llegado al final y seleccionar el botón reinicia la reproducción desde el principio.
...
Para configurar un botón de reproducción/pausa de 32 x 32 píxeles y colocar seis píxeles desde el borde superior e izquierdo de la barra de control. Finalmente, muestra una imagen diferente para cada uno de los cuatro estados de botón diferentes cuando se selecciona o no.
