...
description: El botón de reproducción/pausa hace que el reproductor de vídeo reproduzca o ponga en pausa el contenido de vídeo cuando un usuario lo selecciona.
...
El botón Reproducir/Pausa hace que el reproductor de vídeo reproduzca o ponga en pausa el contenido de vídeo cuando un usuario lo selecciona.
...
>
>`replay='true'` Este atributo se establece cuando el vídeo ha llegado al final y, al seleccionar el botón, se reinicia la reproducción desde el principio.
