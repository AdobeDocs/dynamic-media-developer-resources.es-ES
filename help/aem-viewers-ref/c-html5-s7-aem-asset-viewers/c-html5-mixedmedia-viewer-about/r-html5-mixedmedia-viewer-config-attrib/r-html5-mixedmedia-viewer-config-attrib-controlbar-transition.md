...
<table id="table_76B7F064B9CD46BA86931A9C841F777B"> 
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Especifica el tiempo, en segundos, entre el último suceso de mouse/contacto que registra la barra de control y el momento en que la barra de control se oculta. </p> <p> Si está configurado como <span class="codeph"> -1</span>, el componente nunca déclencheur su efecto de ocultación automática y siempre permanece visible en la pantalla. </p> </td> 
  </tr> 
  <tr> 
