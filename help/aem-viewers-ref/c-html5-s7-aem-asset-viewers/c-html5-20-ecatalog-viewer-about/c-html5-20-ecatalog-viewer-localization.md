...
Cada contenido textual del visualizador que se puede localizar se representa mediante un identificador especial del SDK del visualizador denominado SYMBOL. Cualquier SYMBOL tiene un valor de texto asociado predeterminado para la configuración regional en inglés ( `"en"`) se proporciona con el visor incorporado, y también puede tener valores definidos por el usuario configurados para tantas configuraciones regionales como sea necesario.
...
<table id="table_58C40353B7244335872350C98DF2CFB3"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Etiqueta de página que genera el visor en el momento de la carga. </p> <p>El nombre de ese símbolo es una plantilla, donde <span class="codeph"> XX </span> es un índice de difusión basado en cero en orientación horizontal, y opcional <span class="codeph"> YY </span> es un índice de página basado en cero dentro del pliego segmentado por <span class="codeph"> XX </span>. </p> <p>Se aplica solo al recurso cargado inicialmente; ignorado si un recurso se cambia usando la variable <span class="codeph"> setAsset() </span> Llamada de API. </p> </td> 
  </tr> 
  <tr> 
