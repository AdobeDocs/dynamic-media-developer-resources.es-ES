...
description: Al tocar o hacer clic en este botón, se lleva al usuario a la última página del catálogo. Este botón aparece en la barra de control principal de los sistemas de escritorio y las tabletas; en los teléfonos móviles se añade a una barra de control secundaria. Puede cambiar el tamaño, la apariencia y la posición de este botón mediante CSS.
...
Al pulsar o seleccionar este botón, el usuario llega a la última página del catálogo. Este botón aparece en la barra de control principal de los sistemas de escritorio y las tabletas; en los teléfonos móviles se añade a una barra de control secundaria. Puede cambiar el tamaño, la apariencia y la posición de este botón mediante CSS.
...
Ejemplo: Para configurar un último botón de página de 28 x 28 píxeles situado a 4 píxeles de la parte inferior y a 220 píxeles del borde izquierdo de la barra de control principal. Y, finalmente, muestra una imagen diferente para cada uno de los cuatro estados de botón diferentes.
