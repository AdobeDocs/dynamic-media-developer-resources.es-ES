...
Ejemplo: Para configurar un primer botón de página de 28 x 28 píxeles y situado a 4 píxeles de la parte inferior y a 220 píxeles del borde izquierdo de la barra de control principal. Y, finalmente, muestra una imagen diferente para cada uno de los cuatro estados de botón diferentes.
