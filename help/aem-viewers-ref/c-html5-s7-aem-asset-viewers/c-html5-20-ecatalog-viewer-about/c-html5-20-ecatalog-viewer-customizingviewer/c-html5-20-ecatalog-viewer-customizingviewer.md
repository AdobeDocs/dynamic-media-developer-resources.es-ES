...
Para ayudar a crear CSS diseñada y adaptable, el visor admite marcadores CSS. Las clases CSS especiales se asignan dinámicamente al elemento contenedor del visor de nivel superior en función del tamaño del visor de tiempo de ejecución y el tipo de entrada utilizado en el dispositivo actual.
...
El uso de marcadores CSS es la forma más flexible de crear CSS adaptable. Le permite segmentar no solo el tamaño de la pantalla del dispositivo, sino también el tamaño real del visor, lo que puede resultar útil para los diseños de página interactivos.
...
A continuación se muestra la documentación de referencia de elementos de la interfaz de usuario que se aplica al visor de catálogos electrónicos:
