...
Ejemplo: para configurar un botón de página anterior de 28 x 28 píxeles, posicionado 4 píxeles desde la parte inferior y 250 píxeles desde el borde derecho de la barra de control principal, y muestra una imagen diferente para cada uno de los cuatro estados de botón diferentes.
