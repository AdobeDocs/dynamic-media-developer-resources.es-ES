...
description: Al tocar o hacer clic en este botón se restablece el visualizador entre la vista principal y las miniaturas. Este botón aparece en la barra de control principal. Puede cambiar el tamaño, la apariencia y la posición de este botón mediante CSS.
...
Al seleccionar o pulsar este botón se restablece el visualizador entre la vista principal y las miniaturas. Este botón aparece en la barra de control principal. Puede cambiar el tamaño, la apariencia y la posición de este botón mediante CSS.
...
Ejemplo: configurar un botón de miniaturas de 28 x 28 píxeles y situado a 4 píxeles de la parte inferior y a 5 píxeles del borde izquierdo de la barra de control principal. Y, por último, muestra una imagen diferente para cada uno de los cuatro estados de botón cuando se selecciona o no se selecciona.
