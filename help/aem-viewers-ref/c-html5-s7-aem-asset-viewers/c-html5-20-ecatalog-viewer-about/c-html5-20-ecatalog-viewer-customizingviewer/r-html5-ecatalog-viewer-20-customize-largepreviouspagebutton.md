...
Ejemplo: para configurar un botón grande de la página anterior de 56 x 56 píxeles, centrado verticalmente y anclado al borde izquierdo del visor, y muestra una imagen diferente para cada uno de los cuatro estados de botón diferentes.
