...
Ejemplo: para configurar un botón Agregar favorito de 28 x 28 píxeles. Además, muestra una imagen diferente para cada uno de los cuatro estados de botón diferentes cuando se selecciona o no.
