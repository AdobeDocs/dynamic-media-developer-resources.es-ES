...
Ejemplo: para configurar un botón de uso compartido de vínculos de 28 x 28 píxeles y muestra una imagen diferente para cada uno de los cuatro estados de botón diferentes:
