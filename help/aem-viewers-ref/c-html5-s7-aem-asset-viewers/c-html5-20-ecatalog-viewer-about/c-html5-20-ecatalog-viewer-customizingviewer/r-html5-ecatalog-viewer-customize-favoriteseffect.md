...
En sistemas de escritorio, el componente admite el selector de atributos `cursortype` que puede aplicar a la clase `.s7favoriteseffect` y controla el tipo de cursor en función de la acción de usuario seleccionada. Se admiten los siguientes `cursortype` valores:
...
Ejemplo: Tener diferentes cursores de ratón para cada tipo de estado de componente.
