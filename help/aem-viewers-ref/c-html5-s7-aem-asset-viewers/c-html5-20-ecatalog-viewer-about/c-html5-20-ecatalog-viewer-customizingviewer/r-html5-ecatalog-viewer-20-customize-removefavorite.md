...
description: El menú Favoritos administra completamente la posición del botón Quitar favorito.
...
El menú Favoritos administra completamente la posición del botón Quitar favorito.
...
Ejemplo: para configurar un botón Eliminar favorito de 28 x 28 píxeles y mostrar una imagen diferente para cada uno de los cuatro estados de botón cuando está seleccionado o no.
