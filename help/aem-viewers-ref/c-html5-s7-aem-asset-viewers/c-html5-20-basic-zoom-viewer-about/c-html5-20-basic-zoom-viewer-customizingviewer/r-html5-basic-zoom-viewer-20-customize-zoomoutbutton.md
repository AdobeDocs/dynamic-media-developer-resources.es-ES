...
Ejemplo: para configurar un botón de alejamiento de 32 x 32 píxeles y colocar seis píxeles desde el borde superior y derecho del visor. Debe mostrar una imagen diferente para cada uno de los cuatro estados de botón diferentes.
