...
Ejemplo: para configurar informaciones de objeto que tengan un borde gris con un radio de esquina de tres píxeles, fondo negro y texto blanco escrito con Arial®, un tamaño de 11 píxeles:
