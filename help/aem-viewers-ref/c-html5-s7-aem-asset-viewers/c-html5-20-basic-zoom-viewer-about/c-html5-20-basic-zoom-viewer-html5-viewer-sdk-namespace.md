...
Por ejemplo, si tiene pensado escuchar el `StatusEvent.NOTF_VIEW_READY` evento y AEM proporciona el visor, el tipo de evento completo es `s7viewers.s7sdk.event.StatusEvent.NOTF_VIEW_READY`y el código del oyente de evento tiene un aspecto similar al siguiente:
