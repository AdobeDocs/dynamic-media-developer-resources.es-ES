...
Por ejemplo, si planea escuchar el evento `StatusEvent.NOTF_VIEW_READY` y el Experience Manager proporciona el visor, el tipo de evento completo es `s7viewers.s7sdk.event.StatusEvent.NOTF_VIEW_READY` y el código de detector de eventos tiene un aspecto similar al siguiente:
