...
Últimas notas de la versión que describen las funciones, mejoras y correcciones más recientes de la solución Adobe Experience Manager de [!DNL Adobe Scene7 Publishing System] 6.8 en la [!DNL Adobe Marketing Cloud].
...
* Convierte el correo electrónico de contraseña olvidada de HTML en texto sin formato para evitar la inclusión en la lista negra.
