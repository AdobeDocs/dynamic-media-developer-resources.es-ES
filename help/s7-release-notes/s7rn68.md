...
* [Notas de la versión para visores de servicio de imágenes de Dynamic Media 5.0.1](s7rn68.md#section-3fc1a827bcc84c0488229d310086ad8e)
...
* Controlador `initComplete` a visores HTML5 para activar funciones después de los visores.
...
* Para evitar la inclusión en la lista de bloqueados, convierta el correo electrónico de contraseña olvidada de HTML a texto sin formato.
* Se ha eliminado la función predeterminada.
* Además de la capacidad de cargar contenido en Scene7 Publishing System mediante la carga desde directorio de servidor (ftp) y cargar direcciones URL, ahora también puede cargar contenido mediante HTTP POST. Consulte la [API del sistema de producción de imágenes](/help/aem-ips-api/c-overview.md) para obtener más información sobre el uso de HTTP POST.
...
* La función de arrastrar y soltar del ratón del Visor de catálogos electrónicos de HTML5 no funciona en Internet Explorer con la página que contiene mapas de imagen.
* Visor de vídeo HTML5 impide el acceso para desbloquear el complemento Flash.
* Los visores HTML5 impiden la impresión en el navegador Firefox.
* El Visor de zoom de HTML5 muestra una ligera inestabilidad al iniciar o restablecer el zoom.
* Compatibilidad con HTTPS para visores HTML5 y AS3.
* autoResize no debe estar en el código de incrustación/URL de copia del visor flotante de HTML.
...
* Flash plug-in y Scene7 Publishing System se han bloqueado debido a que muchas carpetas no tenían suficiente memoria Flash.
...
* Se codificaban caracteres especiales en un correo electrónico &quot;Olvidar contraseña&quot; con formato HTML, lo que provocaba que la contraseña no se mostrara correctamente.
* Falta la información de la cuenta FTP de Scene7 en el correo electrónico de bienvenida de una cuenta de prueba
...
* Se espera que la actualización de mayo de 2014 de Adobe Illustrator y Adobe InDesign presente incompatibilidades con los complementos que crean Scene7 FXG. Estas incompatibilidades afectan a los usuarios de la solución Scene7 Web-to-Print. Si utiliza la web para imprimir de Scene7, no actualice Illustrator ni InDesign a esta actualización de Creative Cloud. En su lugar, siga utilizando la versión anterior a mayo de 2014. Adobe Inc espera el restablecimiento de la compatibilidad de la creación de Scene7 FXG con las versiones más nuevas de Illustrator y InDesign en el periodo de tiempo de otoño de 2014.
...
* Los titulares dinámicos (Flash) quedan obsoletos en esta versión. La adopción de esta función ha sido baja, ya que han surgido otras tecnologías para crear, administrar y ofrecer titulares de sitios web personalizados. La funcionalidad de banner dinámico de Scene7 (Flash) sigue funcionando en el servidor, pero ya no es compatible.
* Recordatorio: El servidor de metadatos y el uso de las API asociadas no se admiten oficialmente desde la versión anterior de Scene7.
* Las extensiones de Creative Suite de Scene7 (paneles Flash) quedaron obsoletas a finales de 2014. Los desarrollos posteriores de los flujos de trabajo de ingesta de contenido se centran en Adobe Experience Manager Dynamic Media y Creative Cloud. Para Scene7, las capacidades de carga y exportación de Scene7 Publishing System se conservan y pueden utilizarse en su lugar.
...
* Sección de cuenta FTP de Scene7 en la plantilla de correo electrónico de bienvenida para el usuario de Media Portal.
...
* Botón Cerrar que se muestra en modo de pantalla completa en los visores HTML5.

## Notas de la versión para visualizadores de Dynamic Media Image Serving 5.0.1 {#section-3fc1a827bcc84c0488229d310086ad8e}
...
* Corregido: el vídeo no cambia de tamaño correctamente en el modo de pantalla completa en Safari 5 al usar la reproducción Flash.
