---
description: Últimas notas de la versión que describen las funciones, mejoras y correcciones más recientes de Adobe Scene7 Publishing System 6.8, que forma parte de la solución Adobe Experience Manager en Adobe Marketing Cloud.
...
Últimas notas de la versión que describen las funciones, mejoras y correcciones más recientes de Adobe Scene7 Publishing System 6.8, que forma parte de la solución Adobe Experience Manager en Adobe Marketing Cloud.

## Notas de la versión de Scene7 Publishing System 6.8 (mayo de 2014) {#topic-4517aab837ea4d6d8204425958860e5a}

Últimas notas de la versión que describen las características, mejoras y correcciones más recientes de [!DNL Adobe Scene7 Publishing System] 6.8, parte de la solución de Adobe Experience Manager en [!DNL Adobe Marketing Cloud].
...
* Integración de informes de vídeo de Adobe Analytics para el visor de vídeo HTML5 y el visor de medios mixtos.
* Seguimiento de eventos de varios visores HTML5 en la misma página.
* Se ha añadido `SetIndicator` al visor de zoom HTML5 y al visor de medios mixtos HTML5 para representar visualmente las muestras en dispositivos móviles.
* API `getComponent` añadida para permitir el acceso externo a los componentes del visor HTML5.
...
* Convierte el correo electrónico de contraseña olvidada de HTML en texto sin formato para evitar la inclusión en la lista de bloqueados.
* Se eliminó la función predeterminada.
* Además de la capacidad de cargar contenido en Scene7 Publishing System mediante la carga de directorios de servidor (ftp) y las URL de carga, ahora también puede cargar contenido mediante el POST HTTP. Consulte la [API del sistema de producción de imágenes](/help/aem-ips-api/c-overview.md) para obtener más información sobre el uso del POST HTTP.
...
* El visor de vídeo HTML5 impide el acceso al complemento de Flash de desbloqueo.
...
* Mensaje de alerta añadido cuando edita la configuración de Adobe Analytics y luego intenta escapar de la configuración sin guardar.
...
* El plugin de Flash y Scene7 Publishing System se bloquean debido a que un gran número de carpetas no tienen suficiente memoria de Flash.
...
* La Compañía de etiquetas no se muestra completamente en la página Configuración de Adobe Analytics.
* No se pueden importar los metadatos.

## Problemas conocidos {#section-b2608177928b4174b080d89c938bb0d3}

* Se espera que la actualización de mayo de 2014 de Adobe Illustrator CC (Creative Cloud) y Adobe InDesign CC introduzca incompatibilidades con los complementos que crean Scene7 FXG. Estas incompatibilidades afectan a los usuarios de la solución de impresión virtual de Scene7. Si utiliza Scene7 Web-to-Print, no actualice Illustrator y InDesign a esta actualización de Creative Cloud. En su lugar, siga utilizando la versión anterior a mayo de 2014. Adobe Systems espera la restauración de la compatibilidad de la creación de Scene7 FXG con versiones más recientes de Illustrator y InDesign en otoño de 2014.
...
* La división mediante guiones de texto no se admitirá en la versión de otoño de Scene7 6.9. Los diccionarios de división mediante guiones definen cómo se pueden dividir y dividir las palabras para admitir un flujo de texto óptimo.
...
* Corregido: El método `selectSwatch` no se activa cuando se incrusta en la función `initViewer()`.
...
* Corregido: El icono de uso compartido en redes sociales no se desvanece con el `controlbar` zoom.
...
* Se añadió la compatibilidad con el modificador `initialBitRate` para seleccionar la velocidad de bits utilizada para la reproducción inicial en el escritorio.
...
* Corregido: Protocolo HTTPS que genera una advertencia de seguridad en IE8 mediante la reproducción de Flash.
* Corregido: El tamaño del vídeo no es correcto en el modo de pantalla completa en Safari 5 con la reproducción en Flash.
