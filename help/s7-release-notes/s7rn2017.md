...
* Vídeo HTML5
   ...
   * Los subtítulos de vídeo requieren un conjunto de reglas de compañía si el alojamiento de la página HTML se suministra desde un servidor externo (no desde un servidor Dynamic Media). Póngase en contacto con el servicio de asistencia técnica de Adobe para obtener ayuda.
