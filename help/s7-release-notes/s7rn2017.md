...
Para obtener documentación completa, consulte [Guía de referencia de visores](https://experienceleague.adobe.com/docs/dynamic-media-developer-resources/library/homeviewers.html).
...
* Vídeo de HTML5
   ...
   * Los subtítulos de vídeo requieren un conjunto de reglas de empresa si la página de HTML se aloja desde un servidor externo (no un servidor [!DNL Dynamic Media]). Póngase en contacto con el Soporte técnico de Adobe para obtener ayuda.
