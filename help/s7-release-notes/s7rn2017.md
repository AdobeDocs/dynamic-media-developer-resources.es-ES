...
Últimas notas de la versión para Adobe Dynamic Media Classic: parte de la solución Adobe Experience Manager en Adobe Experience Cloud.

## Notas de la versión de Dynamic Media {#topic-1f5af440670a42f3bbb662eb86a196c6}

Las notas de la última versión de Adobe Dynamic Media Classic forman parte de la [!DNL Adobe Experience Manager] en el [!DNL Adobe Experience Cloud].
...
* Vídeo de HTML5
   ...
   * Los subtítulos de vídeo requieren un conjunto de reglas de la empresa si el alojamiento de la página HTML se sirve desde un servidor externo (no un servidor Dynamic Media). Póngase en contacto con el servicio de asistencia al Adobe para obtener ayuda.
