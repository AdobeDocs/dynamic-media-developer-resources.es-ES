...
* [Dynamic Media Image Serving 6.3.2 y procesamiento de imágenes 6.3.2](s7rn2017.md#section-19a3e96f52c74757bcdea0f8a11001f2)
...
Para obtener la documentación completa, consulte [https://experienceleague.adobe.com/docs/dynamic-media-classic/using/intro/introduction.html#intro](https://experienceleague.adobe.com/docs/dynamic-media-classic/using/intro/introduction.html#intro)
...
* Vídeo HTML5
   ...
   * Los subtítulos de vídeo requieren un conjunto de reglas de compañía si el alojamiento de la página HTML se proporciona desde un servidor externo (no desde un servidor Dynamic Media). Póngase en contacto con el servicio de asistencia al Adobe para obtener ayuda.
