...
* **Aviso de fin de vida útil de los visores de FlashA** *partir del 31 de enero de 2017, Adobe Scene7 (ahora Dynamic Media Classic) finalizó oficialmente la compatibilidad con la plataforma de visor de Flash.*
...
* El vídeo UGC está obsoleto en esta versión debido a que no se ha adoptado correctamente. La configuración de otra cuenta de Dynamic Media Classic puede servir como solución de reemplazo para el vídeo UGC. Póngase en contacto con el servicio de asistencia técnica de Adobe para configurar otra cuenta.
