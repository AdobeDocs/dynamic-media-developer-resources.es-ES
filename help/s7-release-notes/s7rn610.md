...
Últimas notas de la versión que describen las nuevas funciones, mejoras y correcciones de la solución [!DNL Adobe Scene7 Publishing System] de [!DNL Adobe Experience Manager] 6.10 en [!DNL Adobe Experience Cloud].
...
* Se ha eliminado el uso del estilo :visible de visibilidad en los componentes de SDK.
