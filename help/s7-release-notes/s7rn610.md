...
* **Se ha agregado nueva configuración a los visores de catálogo electrónico predeterminados de HTML5** - En **[!UICONTROL Configuración]** > **[!UICONTROL Configuración de aplicación]** > **[!UICONTROL Ajustes preestablecidos de visor]** > `Universal_HTML5_eCatalog` o `Universal_HTML5_eCatalog_Adv`, se agregaron las siguientes opciones a la página [!DNL Configure Viewer] correspondiente de cada visor:
...
* Opción de resincronización del servidor de catálogos en Validar Publish de IPS Classic: eliminada.
...
**Corrección de errores para el Scene7 OnDemand 5.0.3**
...
* La configuración de Publish no mostraba perfiles de color de la empresa de Assets compartido de Scene7.
...
* El formato incorrecto de `clientAddressFilter` estaba causando una excepción del servidor de catálogo al usar la configuración de Publish de servicio de imágenes de prueba segura.
* La opción Copiar URL para el PDF falla en el explorador Chrome cuando hay varios espacios consecutivos en la dirección URL.
...
* Se ha añadido la opción de tipo Publish para servicio de imágenes.
...
* **Aviso de fin de vida útil de los visualizadores de Flash** *A partir del 31 de enero de 2017, Adobe Scene7 (ahora Dynamic Media Classic) dejará de ofrecer asistencia oficial para la plataforma de visualizadores de Flash.*
