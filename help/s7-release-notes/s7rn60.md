...
* Después de esta versión, se implementará gradualmente una nueva función Publicación instantánea. Esta función reemplazará la funcionalidad actual &quot;Marcar para publicación&quot;. Algunos usuarios verán la nueva funcionalidad antes que otras. Los elementos de la interfaz de usuario y la documentación de SPS se actualizarán cuando el periodo de implementación esté cerca de completarse. Recibirá un correo electrónico con más detalles cuando comience el despliegue.
...
* Vista de metadatos para mostrar solo los campos que contienen valores
   ...
   Hay una nueva vista de metadatos predefinida llamada &quot;Todas las propiedades con valores&quot; que solo muestra las metapropiedades que contienen valores. XMP Las propiedades (de los campos definidos por el usuario, los campos definidos por el usuario o los nuevos esquemas de metadatos) sin valores están ocultas y no aparecerán.
