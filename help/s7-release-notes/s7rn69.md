...
* Monitorización de la función Invalidar caché de CDN. Después de seleccionar la plantilla de invalidación de CDN (consulte [Configuración general](https://experienceleague.adobe.com/docs/dynamic-media-classic/using/setup/application-setup.html#general-settings)) y un **[!UICONTROL Invalidar CDN]** Cuando se realiza una solicitud de, aparece un indicador con una estimación de cuánto tiempo se tarda en borrar la caché.
