---
description: Últimas notas de la versión que describen las funciones, mejoras y correcciones más recientes de Adobe Scene7 Publishing System 6.9, que forma parte de la solución de Adobe Experience Manager en el Adobe Marketing Cloud.
seo-description: Últimas notas de la versión que describen las funciones, mejoras y correcciones más recientes de Adobe Scene7 Publishing System 6.9, que forma parte de la solución de Adobe Experience Manager en el Adobe Marketing Cloud.
...
Últimas notas de la versión que describen las funciones, mejoras y correcciones más recientes de Adobe Scene7 Publishing System 6.9, que forma parte de la solución de Adobe Experience Manager en el Adobe Marketing Cloud.

## Notas de la versión de Scene7 Publishing System 6.9 (octubre de 2014) {#topic-1d3011ecca71488abe0d8156a9fc1b97}

Últimas notas de la versión que describen las funciones, mejoras y correcciones más recientes de la solución de Adobe Experience Manager de [!DNL Adobe Scene7 Publishing System] 6.9 en la [!DNL Adobe Marketing Cloud].
...
* **Función** SSO (Registro único): ahora puede iniciar Scene7 sin problemas desde Adobe Marketing Cloud y utilizar su Adobe ID para iniciar sesión en Scene7.
...
* Se han cambiado los visores para que utilicen las solicitudes de seguimiento en lugar de las solicitudes de página para el seguimiento de Analytics de Adobe
