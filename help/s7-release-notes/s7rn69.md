...
* Monitoreo de la función de caché de CDN de invalidación: después de seleccionar la plantilla de invalidación de CDN (consulte [Configuración general](https://experienceleague.adobe.com/docs/dynamic-media-classic/using/setup/application-setup.html#general-settings)), se realiza una solicitud **[!UICONTROL Invalidar CDN]** desde el menú Archivo en SPS, ahora aparece un indicador en la interfaz de usuario que proporciona una estimación del tiempo que tardará en borrarse la caché.
